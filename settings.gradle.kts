...
include(
  ...
  ":dd-java-agent:instrumentation:jdk:jdk-java-concurrent:jdk-java-concurrent-1.8",
  ":dd-java-agent:instrumentation:jdk:jdk-java-concurrent:jdk-java-concurrent-21.0",
  ":dd-java-agent:instrumentation:jdk:jdk-java-concurrent:jdk-java-concurrent-25.0",
  ":dd-java-agent:instrumentation:jdk:jdk-java-nio-1.8",
  ":dd-java-agent:instrumentation:jdk:jdk-java-io-1.8",
  ":dd-java-agent:instrumentation:jdk:jdk-java-lang:jdk-java-lang-1.8",
  ":dd-java-agent:instrumentation:jdk:jdk-java-lang:jdk-java-lang-9.0",
  ":dd-java-agent:instrumentation:jdk:jdk-java-lang:jdk-java-lang-11.0",
  ":dd-java-agent:instrumentation:jdk:jdk-java-lang:jdk-java-lang-15.0",
  ":dd-java-agent:instrumentation:jdk:jdk-java-lang:jdk-java-lang-17.0",
  ":dd-java-agent:instrumentation:jdk:jdk-java-net:jdk-java-net-1.8",
  ":dd-java-agent:instrumentation:jdk:jdk-java-net:jdk-java-net-11.0",
  ":dd-java-agent:instrumentation:jdk:jdk-java-security-1.8",
  ":dd-java-agent:instrumentation:jdk:jdk-java-util-1.8",
