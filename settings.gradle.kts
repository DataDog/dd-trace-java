...
val skipBuildscan = System.getenv("SKIP_BUILDSCAN")?.toBoolean() ?: false
develocity {
  buildScan {
...
include(
  ...
  ":dd-java-agent:instrumentation:aws-common",
  ":dd-java-agent:instrumentation:aws-java-dynamodb-2.0",
  ":dd-java-agent:instrumentation:aws-java-eventbridge-2.0",
  ":dd-java-agent:instrumentation:aws-java-sdk-1.11.0",
  ":dd-java-agent:instrumentation:aws-java-sdk-2.2",
  ":dd-java-agent:instrumentation:aws-java-sfn-2.0",
  ":dd-java-agent:instrumentation:aws-java-sns-1.0",
  ":dd-java-agent:instrumentation:aws-java-sns-2.0",
  ":dd-java-agent:instrumentation:aws-java-sqs-1.0",
  ":dd-java-agent:instrumentation:aws-java-sqs-2.0",
  ":dd-java-agent:instrumentation:aws-java-s3-2.0",
  ":dd-java-agent:instrumentation:aws-lambda-handler",
