...
abstract class AbstractSmokeTest extends Specification {
  ...
  public static final int PROFILING_PERIODIC_RECORDING_DURATION_SECONDS = 9
  public static final int PROFILING_PERIODIC_RECORDING_PERIOD_SECONDS = 10
  public static final int PROFILING_CONTINUOUS_RECORDING_UPLOAD_PERIOD_SECONDS = 10
  ...
  def setupSpec() {
    ...
    defaultJavaProperties = [
      ...
      "-Ddd.profiling.periodic.duration=${PROFILING_PERIODIC_RECORDING_DURATION_SECONDS}",
      "-Ddd.profiling.periodic.period=${PROFILING_PERIODIC_RECORDING_PERIOD_SECONDS}",
      "-Ddd.profiling.periodic.delay=0",
      "-Ddd.profiling.continuous.upload.period=${PROFILING_CONTINUOUS_RECORDING_UPLOAD_PERIOD_SECONDS}",
