...
abstract class AbstractIastSpringBootSmokeTest extends AbstractServerSmokeTest {

  static final String TAG_NAME = '_dd.iast.json'
  ...
  boolean hasVulnerabilityInLogs(final Predicate<?> predicate) {
    def found = false
