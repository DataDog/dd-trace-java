...
public final class TestAgentBackend extends AgentBackend {
  ...
  /**
   * Returns the default dd-apm-test-agent image.
   *
   * @return The default image reference.
   */
  static String defaultImage() {
    String image = System.getenv("CI") != null ? DEFAULT_CI_IMAGE : DEFAULT_PUBLIC_IMAGE;
    return image + ":" + DEFAULT_VERSION;
  }
