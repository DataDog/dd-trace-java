...
public class ProbeFileIntegrationTest extends ServerAppDebuggerIntegrationTest {
  ...
  public void setup(TestInfo testInfo) throws Exception {
    ...
    probeFilePath = Paths.get(ProbeFileIntegrationTest.class
  ...
  void testProbeFile() throws Exception {
    ...
    processRequests(() -> snapshotReceived.get() && traceReceived.get(), () -> String.format(
        "Timeout! traceReceived=%s snapshotReceived=%s",
        traceReceived,
        snapshotReceived
    ));
