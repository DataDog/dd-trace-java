[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "_dd.test.is_user_provided_service" : "true",
      "env" : "integration-test",
      "execution" : "default-prepare-agent",
      "language" : "jvm",
      "library_version" : ${content_meta_library_version},
      "os.architecture" : ${content_meta_os_architecture},
      "os.platform" : ${content_meta_os_platform},
    ...
    "metrics" : { },
    "name" : "Maven_Smoke_Tests_Project_jacoco_maven_plugin_default_prepare_agent",
    "parent_id" : ${content_test_session_id},
    "resource" : "Maven_Smoke_Tests_Project_jacoco_maven_plugin_default_prepare_agent",
    "service" : "test-maven-service",
