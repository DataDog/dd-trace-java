[ {
  ...
  "content" : {
    ...
    "resource" : "datadog.smoke.TestFailed.test_another_failed",
    "service" : "test-maven-service",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.framework_version" : "4.13.2",
      "test.module" : "Maven Smoke Tests Project maven-surefire-plugin default-test",
      "test.source.file" : "src/test/java/datadog/smoke/TestSucceeded.java",
      "test.status" : "pass",
      "test.suite" : "datadog.smoke.TestSucceeded",
      "test.type" : "test",
      "test_session.name" : "mvn -B test"
    },
    "metrics" : {
    ...
    "name" : "junit.test_suite",
    "resource" : "datadog.smoke.TestSucceeded",
    "service" : "test-maven-service",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.framework_version" : "4.13.2",
      "test.module" : "Maven Smoke Tests Project maven-surefire-plugin default-test",
      "test.name" : "test_another_succeeded",
      "test.skip_reason" : "Flaky test is disabled by Datadog",
      "test.source.file" : "src/test/java/datadog/smoke/TestSucceeded.java",
      "test.source.method" : "test_another_succeeded()V",
      "test.status" : "skip",
      "test.suite" : "datadog.smoke.TestSucceeded",
      "test.test_management.is_test_disabled" : "true",
      "test.type" : "test",
    ...
    "name" : "junit.test",
    "parent_id" : ${content_parent_id},
    "resource" : "datadog.smoke.TestSucceeded.test_another_succeeded",
    "service" : "test-maven-service",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.framework_version" : "4.13.2",
      "test.module" : "Maven Smoke Tests Project maven-surefire-plugin default-test",
      "test.name" : "test_succeeded",
      "test.source.file" : "src/test/java/datadog/smoke/TestSucceeded.java",
      "test.source.method" : "test_succeeded()V",
      "test.status" : "pass",
      "test.suite" : "datadog.smoke.TestSucceeded",
      "test.test_management.is_attempt_to_fix" : "true",
      "test.test_management.is_quarantined" : "true",
    ...
    "metrics" : {
      "_dd.host.vcpu_count" : ${content_metrics__dd_host_vcpu_count_12},
      "_dd.profiling.enabled" : 0,
      "_dd.trace_span_attribute_schema" : 0,
      "process_id" : ${content_metrics_process_id_2},
      "test.source.end" : 12,
    ...
    "name" : "junit.test",
    "parent_id" : ${content_parent_id},
    "resource" : "datadog.smoke.TestSucceeded.test_succeeded",
    "service" : "test-maven-service",
  ...
  "content" : {
    ...
    "metrics" : {
      "_dd.host.vcpu_count" : ${content_metrics__dd_host_vcpu_count_13},
      "_dd.profiling.enabled" : 0,
      "_dd.trace_span_attribute_schema" : 0,
      "process_id" : ${content_metrics_process_id_2},
      "test.source.end" : 12,
  ...
  "content" : {
    ...
    "metrics" : {
      "_dd.host.vcpu_count" : ${content_metrics__dd_host_vcpu_count_14},
      "_dd.profiling.enabled" : 0,
      "_dd.trace_span_attribute_schema" : 0,
      "process_id" : ${content_metrics_process_id_2},
      "test.source.end" : 12,
  ...
  "content" : {
    ...
    "metrics" : {
      "_dd.host.vcpu_count" : ${content_metrics__dd_host_vcpu_count_15},
      "_dd.profiling.enabled" : 0,
      "_dd.trace_span_attribute_schema" : 0,
      "process_id" : ${content_metrics_process_id_2},
      "test.source.end" : 12,
  ...
  "content" : {
    ...
    "metrics" : {
      "_dd.host.vcpu_count" : ${content_metrics__dd_host_vcpu_count_16},
      "_dd.profiling.enabled" : 0,
      "_dd.trace_span_attribute_schema" : 0,
      "process_id" : ${content_metrics_process_id_2},
      "test.source.end" : 12,
