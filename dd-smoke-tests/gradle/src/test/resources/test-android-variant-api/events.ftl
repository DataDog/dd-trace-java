[ {
  ...
  "content" : {
    ...
    "metrics" : { },
    "name" : "compileTestFixturesJava",
    "parent_id" : ${content_test_session_id},
    "resource" : "compileTestFixturesJava",
    "service" : "test-gradle-service",
  ...
  "content" : {
    ...
    "metrics" : { },
    "name" : "processTestFixturesResources",
    "parent_id" : ${content_test_session_id},
    "resource" : "processTestFixturesResources",
    "service" : "test-gradle-service",
  ...
  "content" : {
    ...
    "metrics" : { },
    "name" : "testFixturesClasses",
    "parent_id" : ${content_test_session_id},
    "resource" : "testFixturesClasses",
    "service" : "test-gradle-service",
  ...
  "content" : {
    ...
    "metrics" : { },
    "name" : "testFixturesJar",
    "parent_id" : ${content_test_session_id},
    "resource" : "testFixturesJar",
    "service" : "test-gradle-service",
