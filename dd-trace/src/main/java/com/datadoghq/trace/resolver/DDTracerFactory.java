...
public class DDTracerFactory {
    ...
    public static DDTracer create(TracerConfig config) {
        String defaultServiceName =
                config.getDefaultServiceName() != null ? config.getDefaultServiceName() : DDTracer.UNASSIGNED_DEFAULT_SERVICE_NAME;
    ...
    public static DDTracer createFromConfigurationFile() {
        TracerConfig tracerConfig = FactoryUtils
                .loadConfigFromFilePropertyOrResource(SYSTEM_PROPERTY_CONFIG_PATH, CONFIG_PATH, TracerConfig.class);
