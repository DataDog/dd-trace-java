...
public abstract class CallSiteConstants {
  ...
  public static final String INVOKE_DYNAMIC_CALL_SITE_CLASS = "java.lang.invoke.CallSite";

  public static final String INVOKE_DYNAMIC_LOOKUP_CLASS = "java.lang.invoke.MethodHandles$Lookup";
