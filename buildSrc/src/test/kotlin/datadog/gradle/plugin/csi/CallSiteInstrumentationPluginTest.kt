...
class CallSiteInstrumentationPluginTest {
  ...
  private fun createGradleProject(buildDir: File, gradleFile: String, advice: String) {
    ...
    val callSiteJar =
      resolve(projectFolder, "buildSrc", "call-site-instrumentation-plugin", "build", "libs", "call-site-instrumentation-plugin-all.jar")
    ...
    val csiSource =
      resolve(projectFolder, "dd-java-agent", "agent-tooling", "src", "main", "java", "datadog", "trace", "agent", "tooling", "csi")
  ...
  private fun buildGradleProject(buildDir: File): BuildResult = GradleRunner
    .create()
