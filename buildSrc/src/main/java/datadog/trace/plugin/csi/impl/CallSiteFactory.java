...
public abstract class CallSiteFactory {
  ...
  public static AdviceGenerator adviceGenerator(
    ...
    return new FreemarkerAdviceGenerator(
        targetFolder, pointcutParser(), stackHandler(), typeResolver);
  }
  ...
  public static StackHandler stackHandler() {
    return new CacheableStackHandler(new ValidationDrivenStackHandler());
  }
