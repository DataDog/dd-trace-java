...
abstract class HttpServerTest<SERVER> extends WithHttpServer<SERVER> {
  ...
  @Flaky(value = "https://github.com/DataDog/dd-trace-java/issues/9396", suites = ["PekkoHttpServerInstrumentationAsyncTest", "PekkoHttpServerInstrumentationAsyncHttp2Test"])
  def "test exception"() {
    setup:
    def method = "GET"
    def body = null
