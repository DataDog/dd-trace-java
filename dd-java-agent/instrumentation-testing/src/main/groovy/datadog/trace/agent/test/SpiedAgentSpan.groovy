...
class SpiedAgentSpan implements AgentSpan {
  ...
  ConcurrentHashMap<AgentSpan, AgentSpan> originalToSpySpan,
  ...
  AgentSpan getLocalRootSpan() {
    AgentSpan unwrappedSpan = delegate.getLocalRootSpan()
    return originalToSpySpan.getOrDefault(unwrappedSpan, unwrappedSpan)
  }
