...
class ModifierMatchersTest extends DDSpecification {
  ...
  def "test nonAbstract"() {
    ...
    ACC_PROTECTED                             | true
    PUBLICFINAL                               | true
    PublicAbstract.getModifiers()             | false
    PublicFinal.getModifiers()                | true
    getMethodModifiers(Foo, "publicStatic")   | true
    getMethodModifiers(Foo, "protectedFinal") | true
