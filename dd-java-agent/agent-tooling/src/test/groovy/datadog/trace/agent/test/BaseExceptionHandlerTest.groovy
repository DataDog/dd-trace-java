...
abstract class BaseExceptionHandlerTest extends DDSpecification {
  ...
  def setupSpec() {
    ...
    AgentBuilder builder = new AgentBuilder.Default()
      ...
      .withExceptionHandler(ExceptionHandlers.defaultExceptionHandler(BadAdvice.getName()))
      .advice(
      ...
      new AgentBuilder.Transformer.ForAdvice()
      .with(new AgentBuilder.LocationStrategy.Simple(ClassFileLocator.ForClassLoader.of(BadAdvice.getClassLoader())))
      .withExceptionHandler(ExceptionHandlers.defaultExceptionHandler(BadAdvice.NoOpAdvice.getName()))
      .advice(
      ...
      new AgentBuilder.Transformer.ForAdvice()
      .with(new AgentBuilder.LocationStrategy.Simple(ClassFileLocator.ForClassLoader.of(BadAdvice.getClassLoader())))
      .withExceptionHandler(ExceptionHandlers.defaultExceptionHandler(BlockingExceptionAdvice.getName()))
      .advice(
