...
public class ArrayBeforeInstrumenter extends CallSiteTypeBaseInstrumenter {

  public ArrayBeforeInstrumenter() {
    super("beforeArray", new BeforeCallSite());
  }
  ...
  public static class BeforeCallSite extends BaseCallSiteAdvice implements CallSiteAdvice.HasFlags {
    ...
    public void apply(
        ...
        String descriptor,
        boolean isInterface) {
      handler.dupInvoke(owner, descriptor, StackDupMode.COPY_ARRAY);
      handler.method(
