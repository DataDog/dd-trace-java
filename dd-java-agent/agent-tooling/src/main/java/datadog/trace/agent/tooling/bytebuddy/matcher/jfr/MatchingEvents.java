      ...
      try {
        ...
        return (MatchingEvents)
            AgentInstaller.class
                .getClassLoader()
                .loadClass("datadog.trace.agent.tooling.bytebuddy.matcher.jfr.MatchingEventsImpl")
                .getField("INSTANCE")
                .get(null);
      } catch (Throwable e) {
        log.warn(
            "Problem loading Java 8 JFR events support, falling back to no-op implementation.", e);
      }
    }
