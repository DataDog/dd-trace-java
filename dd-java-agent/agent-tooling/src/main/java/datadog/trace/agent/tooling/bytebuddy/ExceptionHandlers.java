...
public class ExceptionHandlers {
  ...
  private static final StackManipulation EXCEPTION_STACK_MANIPULATION = new StackManipulation() {
  ...
  public static ExceptionHandler exceptionHandlerFor(final String adviceClassName) {
    return new ExceptionHandler.Simple(new StackManipulation.Compound(
