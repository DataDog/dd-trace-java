...
public class ModifierMatchers {
  ...
  public enum ModifierConstraint {
    ...
    static long toMasks(EnumSet<ModifierConstraint> constraints) {
      ...
      for (ModifierConstraint constraint : constraints) {
        masks |= constraint.modifier << (constraint.forbidden ? 32 : 0);
      }
      return masks;
    }
  }
   ...
   * @return a matcher
   */
  public static <T extends ModifierReviewable> ElementMatcher.Junction<T> permitPositiveDenyNegativeModifiers(
