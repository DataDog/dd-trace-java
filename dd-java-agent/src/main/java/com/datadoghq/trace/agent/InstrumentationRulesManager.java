...
public class InstrumentationRulesManager {
  ...
  public InstrumentationRulesManager(
      Retransformer trans, TracingAgentConfig config, AgentRulesManager arm) {
    transformer = trans;
    agentTracerConfig = config;
    agentRulesManager = arm;
   ...
   */
  void uninstallScripts(final List<String> installedScripts, final List<String> patterns)
      throws Exception {
