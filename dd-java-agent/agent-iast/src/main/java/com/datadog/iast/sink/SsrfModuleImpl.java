...
public class SsrfModuleImpl extends SinkModuleBase implements SsrfModule {
  ...
  //  /**
  //   * if the host or the uri are tainted, we report the url as tainted as well a new range is
  // created
  //   * covering all the value string in order to simplify the algorithm
  //   */
  //  @Override
  //  public void onURLConnection(@Nullable String value, @Nullable Object host, @Nullable Object
  // uri) {
  //    if (value == null) {
  //      return;
  //    }
  //    checkInjection(VulnerabilityType.SSRF, Iterators.of(host, uri), new
  // SsrfEvidenceBuilder(value));
  //  }
