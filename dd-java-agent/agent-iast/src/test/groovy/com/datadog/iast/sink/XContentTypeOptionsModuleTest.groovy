...
public class XContentTypeOptionsModuleTest extends IastModuleImplTestBase {
  ...
  private XContentTypeOptionsModuleImpl module

  private AgentSpan span

  def setup() {
    InstrumentationBridge.clearIastModules()
    module = registerDependencies(new XContentTypeOptionsModuleImpl())
  ...
  void 'x content options sniffing vulnerability'() {
    ...
    with(savedVul1) {
      type == VulnerabilityType.XCONTENTTYPEOPTIONS_HEADER_MISSING
    }
  }
