...
class JacksonModuleTest extends IastModuleImplTestBase {
  ...
  void 'onJsonFactoryCreateParser (#content, #result)'(final String content, final Object result, final int mockCalls) {
    given:
    ...
    final contentWithoutTainting = addFromTaintFormat(taintedObjects, content)
    objectHolder.add(contentWithoutTainting)
    final shouldBeTainted = fromTaintFormat(content) != null
