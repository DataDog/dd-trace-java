...
public class DebuggerContextTest {
  ...
  public void metric() {
    ...
    DebuggerContext.metric("probeId", DebuggerContext.MetricKind.GAUGE, GAUGE_METRIC_NAME, 42, null);
    ...
    DebuggerContext.metric(
        "probeId",
        DebuggerContext.MetricKind.GAUGE,
        DOUBLE_GAUGE_METRIC_NAME,
        3.14,
        null
    );
    ...
    DebuggerContext.metric(
        "probeId",
        DebuggerContext.MetricKind.HISTOGRAM,
