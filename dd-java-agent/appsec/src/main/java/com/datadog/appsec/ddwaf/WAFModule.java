...
public class WAFModule implements AppSecModule {
  ...
  public void config(AppSecModuleConfigurer appSecConfigService, WafBuilder wafBuilder)
    ...
    appSecConfigService.addSubConfigListener("waf", (key, reconf) -> applyConfig(wafBuilder));
  ...
  private void applyConfig(WafBuilder wafBuilder)
  ...
  private boolean initOrUpdateWafHandle(WafBuilder wafBuilder)
      throws AppSecModuleActivationException {
    try {
