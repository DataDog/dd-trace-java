...
public class AppSecVersion {
  public static final String JAVA_VERSION = SystemProperties.getOrDefault("java.version", "unknown");
  public static final String JAVA_VM_NAME = SystemProperties.getOrDefault("java.vm.name", "unknown");
