...
/**
 * Configuration model for Supply Chain Analysis (SCA) vulnerability detection. Received via Remote
 ...
 * report known vulnerabilities at runtime.
 */
public class AppSecSCAConfig {
  ...
  /**
   * List of instrumentation targets for SCA analysis. Each target specifies a class/method to
   * instrument for vulnerability detection.
   */
  ...
  public static class InstrumentationTarget {
    /**
     * Fully qualified class name in internal format (e.g.,
