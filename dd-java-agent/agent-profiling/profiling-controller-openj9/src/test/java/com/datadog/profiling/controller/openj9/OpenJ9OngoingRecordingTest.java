...
public class OpenJ9OngoingRecordingTest {
  ...
  private OpenJ9OngoingRecording ongoingRecording;
  ...
  public void setup() throws Exception {
    ongoingRecording = new OpenJ9OngoingRecording(asyncProfiler, TEST_NAME);
  }
