...
public final class ProfilingTestUtils {
  ...
  public static Multimap<String, Object> parseProfilingRequestParameters(
    ...
    return FileUpload
      .parse(request.getBody().readByteArray(), request.getHeader("Content-Type"))
      .stream()
      .collect(ImmutableMultimap::<String, Object>builder, (builder, value) -> builder.put(
          value.getFieldName(),
          OCTET_STREAM.toString().equals(value.getContentType()) ? value.get() : value.getString()
