...
class SmapEntryCacheTest {
  ...
  void getEvents() throws Exception {
    ...
    // set up a really long expiration duration
    SmapEntryCache // set up a really long expiration duration
    smapEntryCache = new SmapEntryCache(Duration.ofHours(1));
    ...
    // pretend expiring the cache
    smapEntryCache.invalidate();
