...
public final class CustomTypeBuilder {
   ...
   * Keeping the default values intentionally 'wrong' in order for things to break soon if this type is not
   * replaced by the concrete type counterpart correctly.
   */
  ...
  public CustomTypeBuilder addField(String name, Types.Predefined type, JFRAnnotation ... annotations) {
  ...
  public CustomTypeBuilder addField(String name, JFRType type, JFRAnnotation ... annotations) {
    fields.add(new TypedField(name, type, annotations != null ? Arrays.asList(annotations) : Collections.emptyList()));
    return this;
  }
  ...
  public CustomTypeBuilder addArrayField(String name, Types.Predefined type, JFRAnnotation ... annotations) {
  ...
  public CustomTypeBuilder addArrayField(String name, JFRType type, JFRAnnotation ... annotations) {
    fields.add(new TypedField(name, type, true, annotations != null ? Arrays.asList(annotations) : Collections.emptyList()));
    return this;
  }
