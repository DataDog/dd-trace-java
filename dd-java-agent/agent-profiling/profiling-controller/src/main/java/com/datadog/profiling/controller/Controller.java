...
public interface Controller {
   ...
   *
   * @param start the (approximate) start time. Start time will be included, if available, but more
   *     data may be included due to chunk boundaries.
   * @param end the (approximate) end time. End time will be included, if available, but more data
