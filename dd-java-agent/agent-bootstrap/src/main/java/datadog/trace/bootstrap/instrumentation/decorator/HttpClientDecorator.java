...
public abstract class HttpClientDecorator<REQUEST, RESPONSE> extends ClientDecorator {
  ...
  public AgentSpan onRequest(final AgentSpan span, final REQUEST request) {
    return onRequest(span, request, true);
  }

  protected AgentSpan onRequest(
      final AgentSpan span, final REQUEST request, boolean setResourceName) {
    if (request != null) {
