...
class HttpClientDecoratorTest extends ClientDecoratorTest {
  ...
  def "test url handling for #url : default env var"() {
    setup:
  ...
  def "test url handling for #url : trace env var"() {
    setup:
    injectSysConfig("trace." + HTTP_CLIENT_TAG_QUERY_STRING, "$tagQueryString")
    def decorator = newDecorator()
  ...
  def "test url handling for #url : both env var"() {
    setup:
    injectSysConfig("trace." + HTTP_CLIENT_TAG_QUERY_STRING, "$tagQueryString")
    boolean revTagQueryString = !tagQueryString
    injectSysConfig(HTTP_CLIENT_TAG_QUERY_STRING, "$revTagQueryString")
    def decorator = newDecorator()
