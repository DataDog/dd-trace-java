...
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_BUILD_NUMBER
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_GIT_BRANCH
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_GIT_COMMIT
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_GIT_REPOSITORY_URL
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_GIT_TAG
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_PIPELINE_ID
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_PROVIDER_NAME
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_REPO_FULL_NAME
import static datadog.trace.bootstrap.instrumentation.decorator.ci.BitBucketInfo.BITBUCKET_WORKSPACE_PATH
