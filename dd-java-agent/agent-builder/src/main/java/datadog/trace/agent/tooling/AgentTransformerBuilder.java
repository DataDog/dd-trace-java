...
public class AgentTransformerBuilder
  ...
  public static Pair<ElementMatcher<? super TypeDescription>, String> typeMatcher(
    ...
    return Pair.of(typeMatcher, hierarchyHint);
  }

  private static AgentBuilder.RawMatcher typeMatcher(Instrumenter.Default instrumenter) {
    Pair<ElementMatcher<? super TypeDescription>, String> typeMatcherAndHierarchyHint =
        typeMatcher(instrumenter, true);
    ...
    String hierarchyHint = typeMatcherAndHierarchyHint.getRight();
    ...
    ElementMatcher<? super TypeDescription> typeMatcher = typeMatcherAndHierarchyHint.getLeft();
