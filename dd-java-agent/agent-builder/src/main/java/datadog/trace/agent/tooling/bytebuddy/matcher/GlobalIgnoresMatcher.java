...
public class GlobalIgnoresMatcher implements AgentBuilder.RawMatcher {
  ...
  public static boolean isIgnored(String name, boolean skipAdditionalIgnores) {
    return GlobalIgnores.isIgnored(name, skipAdditionalIgnores)
  ...
  public boolean matches(
    ...
    String name = typeDescription.getName(); // TODO it used to be getActualName
    return isIgnored(name, skipAdditionalLibraryMatcher)
