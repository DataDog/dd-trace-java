...
public class RedactUtilsTest {
  ...
  void testRedactLibraryPath_offsetFormat() {
    assertThat(RedactUtils.redactLibraryPath(
        "0x0000ffff9efa1650: <offset 0x0000000000e01650> in /opt/company/lib/server/app.so "
        + "at 0x0000ffff9e1a0000"
    ))
      .isEqualTo(
  ...
  void testRedactLibraryPath_symbolOffsetFormat() {
    ...
    assertThat(RedactUtils.redactLibraryPath(
        "0x0000000106c1ccc0: _ZN19TemplateInterpreter13_active_tableE+0 in /Users/USER/."
        + "local/share/mise/installs/java/25.0.2/lib/server/libjvm.dylib at "
        + "0x0000000105efc000"
    ))
      .isEqualTo(
  ...
  void testRedactLibraryPath_cSymbolFormat() {
    ...
    assertThat(RedactUtils.redactLibraryPath(
        "0x0000000182d709d0: pthread_jit_write_protect_np+0 in /usr/lib/system/libsystem_"
  ...
  void testRedactDottedClassOopRef_redactsAnyStringOopRef() {
    ...
    assertThat(RedactUtils.redactDottedClassOopRef(
        " - private transient 'name' 'Ljava/lang/String;' @44  \\\"com.company."
        + "SomeType\\\"{0x00000007142f7200} (0xe285ee40)"
    ))
      .isEqualTo(
          " - private transient 'name' 'Ljava/lang/String;' @44  "
          + "\\\"REDACTED\\\"{0x00000007142f7200} (0xe285ee40)"
      );
    // Dotted names with known packages are also fully redacted — any string can be a secret
    assertThat(RedactUtils.redactDottedClassOopRef(
        " - private transient 'name' 'Ljava/lang/String;' @44  \\\"jdk.internal.misc."
        + "Unsafe\\\"{0x00000007142f7200} (0xe285ee40)"
    ))
      .isEqualTo(
          " - private transient 'name' 'Ljava/lang/String;' @44  "
          + "\\\"REDACTED\\\"{0x00000007142f7200} (0xe285ee40)"
  ...
  void testRedactOopClassName_redactsUnknownPackage() {
    assertThat(RedactUtils.redactOopClassName("0x00000007ffe85850 is an oop: com.company.UserData ")
    )
  ...
  void testRedactRegisterToMemoryMapping_methodDescriptor() {
    String value =
        "{method} {0x00007f3639c2ff00} 'saveJob' '(Lcom/company/Job;ILjava/lang/String;)V' "
        + "in 'com/company/JobService'";
  ...
  void testRedactRegisterToMemoryMapping_libraryPath() {
    assertThat(RedactUtils.redactRegisterToMemoryMapping(
        "0x0000ffff9efa1650: <offset 0x0000000000e01650> in /usr/lib/jvm/corretto-"
        + "21/server/libjvm.so at 0x0000ffff9e1a0000"
    ))
      .isEqualTo(
          "0x0000ffff9efa1650: <offset 0x0000000000e01650> in /redacted/server/libjvm.so at "
          + "0x0000ffff9e1a0000"
      );
  }
  ...
  void testRedactReadableMemoryHexDump_withAddressAndPipe() {
    ...
    assertThat(RedactUtils.redactReadableMemoryHexDump(
        "0x0000000100a17cb0 points into unknown readable memory: 0x00000000ffffffff | ff "
  ...
  void testRedactObjFieldRef_keepsKnownPackage() {
    assertThat(RedactUtils.redactObjFieldRef(
        " - 'loader' 'Ljava/lang/ClassLoader;' @12  a "
        + "'java/lang/ClassLoader'{0x00007f3700001234} (0x12345678)"
    ))
      .isEqualTo(
          " - 'loader' 'Ljava/lang/ClassLoader;' @12  a "
          + "'java/lang/ClassLoader'{0x00007f3700001234} (0x12345678)"
