...
class NettyEpollProfilingInstrumentationForkedTest extends AbstractInstrumentationTest {
  ...
  @Test
  @Timeout(30)
  void nettyEpollEventLoopWaitDispatchesBalancedTaskBlocks() throws InterruptedException {
    ...
    try {
      ...
      // The event loop's own epollWait() call sites run in the background; give it time to
      // accumulate a few idle wait cycles.
