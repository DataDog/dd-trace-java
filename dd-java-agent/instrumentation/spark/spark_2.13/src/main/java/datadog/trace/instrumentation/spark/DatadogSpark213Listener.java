...
public class DatadogSpark213Listener extends AbstractDatadogSparkListener {
  ...
  private static final MethodHandle withExternalAccums =
      methodLoader.method(TaskMetrics.class, "withExternalAccums", new Class[] {Function1.class});
  ...
  protected List<AccumulatorV2> getExternalAccumulators(TaskMetrics metrics) {
    ...
    Function1 lambda = (Function1<ArrayBuffer<AccumulatorV2>, List<AccumulatorV2>>) accumulators -> CollectionConverters.asJava(
        accumulators);
