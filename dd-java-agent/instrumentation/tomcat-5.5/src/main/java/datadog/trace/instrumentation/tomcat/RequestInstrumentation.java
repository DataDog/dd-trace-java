...
public final class RequestInstrumentation extends Instrumenter.Tracing
  ...
  static class ThrowableCaughtVisitorWrapper implements AsmVisitorWrapper {
    @Override
  ...
  static class ThrowableCaughtVisitor extends ClassVisitor {
  ...
  static class ParseParametersMethodVisitor extends MethodVisitor {
