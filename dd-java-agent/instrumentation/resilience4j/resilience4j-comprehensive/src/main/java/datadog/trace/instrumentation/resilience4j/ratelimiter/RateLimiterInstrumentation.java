...
public final class RateLimiterInstrumentation
    implements Instrumenter.ForSingleType, Instrumenter.HasMethodAdvice {
  private static final String RATE_LIMITER_FQCN = "io.github.resilience4j.ratelimiter.RateLimiter";
  private static final String THIS_CLASS = RateLimiterInstrumentation.class.getName();

  @Override
  public String instrumentedType() {
    return RATE_LIMITER_FQCN;
  }
  ...
  public void methodAdvice(MethodTransformer transformer) {
    transformer.applyAdvice(
        isMethod()
            ...
            .and(takesArgument(0, named(RATE_LIMITER_FQCN)))
  ...
  public static class SupplierAdvice {
    ...
    public static void afterExecute(
        @Advice.Argument(value = 0) RateLimiter rateLimiter,
        @Advice.Return(readOnly = false) Supplier<?> result) {
      result = new WrapperWithContext.SupplierWithContext<>(
          result, RateLimiterDecorator.DECORATE, rateLimiter);
    }
  }
