...
import static datadog.trace.agent.test.base.HttpServerTest.getIG_RESPONSE_HEADER
import static datadog.trace.agent.test.base.HttpServerTest.getIG_RESPONSE_HEADER_VALUE

class TestServlet5 extends HttpServlet {
  @Override
  protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    System.err.println("CALLED $req.requestURI")
