...
public class RequestDispatcher3Utils {

  private Set<SessionTrackingMode> sessionTrackingModes;

  RequestDispatcher3Utils() {}

  RequestDispatcher3Utils(Set<SessionTrackingMode> sessionTrackingModes) {
    this.sessionTrackingModes = sessionTrackingModes;
  }

  void getRealPath(final String target) {
    new MockServletContext().getRealPath(target);
  }
