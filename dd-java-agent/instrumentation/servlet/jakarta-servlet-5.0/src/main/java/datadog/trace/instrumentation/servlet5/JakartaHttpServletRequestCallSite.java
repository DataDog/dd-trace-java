...
public class JakartaHttpServletRequestCallSite {
  ...
  @CallSite.After("java.lang.String jakarta.servlet.http.HttpServletRequestWrapper."
      + "getPathTranslated()")
  ...
  @CallSite.After("java.lang.StringBuffer jakarta.servlet.http.HttpServletRequestWrapper."
      + "getRequestURL()")
