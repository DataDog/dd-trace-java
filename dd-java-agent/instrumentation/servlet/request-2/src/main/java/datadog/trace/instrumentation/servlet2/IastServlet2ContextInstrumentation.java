...
public final class IastServlet2ContextInstrumentation extends InstrumenterModule.Iast
  ...
  public void methodAdvice(MethodTransformer transformer) {
    transformer.applyAdvice(
        ...
        IastServlet2ContextInstrumentation.class.getName() + "$IastContextAdvice");
  }
