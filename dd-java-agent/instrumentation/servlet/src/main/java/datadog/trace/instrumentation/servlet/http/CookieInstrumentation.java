    ...
    public static void afterGetName(
      ...
      if (module != null) {
        try {
          ...
          module.taintObjectIfTainted(to, result, self, SourceTypes.REQUEST_COOKIE_NAME, result);
  ...
  public static class GetValueAdvice {
    ...
    public static void afterGetValue(
      ...
      if (module != null) {
        try {
          final TaintedObjects to = IastContext.Provider.taintedObjects();
          module.taintObjectIfTainted(to, result, self, SourceTypes.REQUEST_COOKIE_VALUE, name);
        } catch (final Throwable e) {
