...
class ResponseServiceTest extends OpenAiTest {
  ...
  //   CompletableFuture<Response> completionFuture = runUnderTrace("parent") {
  ...
  //     StreamResponse<ResponseChunk> streamCompletion = openAiClient.responses().createStreaming(responseCreateParams())
  ...
  //   runnableUnderTrace("parent") {
  //     HttpResponseFor<StreamResponse<ResponseChunk>> streamCompletion = openAiClient.responses().withRawResponse().createStreaming(responseCreateParams())
  ...
  //   AsyncStreamResponse<ResponseChunk> asyncResp = runUnderTrace("parent") {
  ...
  //   CompletableFuture<HttpResponseFor<StreamResponse<ResponseChunk>>> future = runUnderTrace("parent") {
  //     openAiClient.async().responses().withRawResponse().createStreaming(responseCreateParams())
  //   }
  //   HttpResponseFor<StreamResponse<ResponseChunk>> resp = future.get()
