...
@SkipDynamicHelpers
public class IndyInterfaceV8CallSite {

  private static final Logger LOG = LoggerFactory.getLogger(IndyInterfaceV8CallSite.class);

  @CallSite.Around(
      value =
          "java.lang.invoke.CallSite org.codehaus.groovy.vmplugin.v8.IndyInterface.bootstrap(java.lang.invoke.MethodHandles$Lookup, java.lang.String, java.lang.invoke.MethodType, java.lang.String, int)",
      invokeDynamic = true)
  public static java.lang.invoke.CallSite aroundBootstrap(
    ...
    if (InvocationHelper.supports(name)) {
      try {
        ...
        LOG.error("Error handling v8.IndyInterface", e);
      }
    }
    return result;
  }
