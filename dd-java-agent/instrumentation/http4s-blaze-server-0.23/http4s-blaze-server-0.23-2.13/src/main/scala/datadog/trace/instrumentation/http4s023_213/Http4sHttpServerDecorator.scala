...
object Http4sHttpServerDecorator {
  val HTTP4S_HTTP_REQUEST: UTF8BytesString = UTF8BytesString.create("http4s.request")
  val HTTP4S_HTTP_SERVER: UTF8BytesString  = UTF8BytesString.create("http4s-server")
...
final class Http4sHttpServerDecorator[F[_]]
  ...
  // This mirrors the names in Http4sHttpServerInstrumentation. I wish there was a better way :(
