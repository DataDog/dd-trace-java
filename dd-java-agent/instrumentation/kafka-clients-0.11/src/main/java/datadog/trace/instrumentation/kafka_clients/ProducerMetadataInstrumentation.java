...
public class ProducerMetadataInstrumentation extends Instrumenter.Tracing
    implements Instrumenter.ForSingleType {

  public ProducerMetadataInstrumentation() {
    super("kafka");
  }

  @Override
  public String instrumentedType() {
    return "org.apache.kafka.clients.producer.internals.ProducerMetadata";
  }
  /*
    @Override
  ...
  */
  ...
  public void adviceTransformations(AdviceTransformation transformation) {
    transformation.applyAdvice(
        isConstructor(),
        ProducerMetadataInstrumentation.class.getName() + "$ProducerMetadataConstructorAdvice");

    transformation.applyAdvice(
        isMethod()
            .and(isPublic())
            .and(named("update")),
        ProducerMetadataInstrumentation.class.getName() + "$ProducerMetadataAdvice");
  }

  public static class $ProducerMetadataConstructorAdvice {
    @Advice.OnMethodExit(suppress = Throwable.class)
    public static void captureGroup(
        @Advice.This Metadata metadata, @Advice.Argument(0) long refreshBackoffMs) {
      System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nPRODUCER METADATA CONSTRUCTOR\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    }
  }

  public static class ProducerMetadataAdvice {

    @Advice.OnMethodEnter(suppress = Throwable.class)
    public static void onEnter(
        @Advice.Argument(value = 1, readOnly = false) MetadataResponse response) {
      System.out.println("[PRODUCER METADATA UPDATE] ON METHOD ENTER");
