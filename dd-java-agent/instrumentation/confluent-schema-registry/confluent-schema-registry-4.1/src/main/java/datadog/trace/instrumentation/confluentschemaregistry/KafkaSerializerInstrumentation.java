...
public class KafkaSerializerInstrumentation
  ...
  public static class ConfigureAdvice {
    ...
    public static void onExit(@Advice.This Serializer serializer, @Advice.Argument(1) boolean isKey) {
  ...
  public static class SerializeAdvice {
    ...
    public static void onExit(
      ...
      Boolean isKeyObj = InstrumentationContext
        .get(Serializer.class, Boolean.class)
        .get(serializer);
