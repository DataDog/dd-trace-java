...
public class ThreadLocalRandomCallSite {
  ...
  @CallSite.Before("java.util.stream.IntStream java.util.concurrent.ThreadLocalRandom.ints(int, "
      + "int)")
  ...
  @CallSite.Before("java.util.stream.DoubleStream java.util.concurrent.ThreadLocalRandom."
  ...
  @CallSite.Before("java.util.stream.LongStream java.util.concurrent.ThreadLocalRandom."
      + "longs(long, long)")
  @CallSite.Before("java.util.stream.LongStream java.util.concurrent.ThreadLocalRandom."
