...
class DirectAllocationTrackingTest extends InstrumentationSpecification {
  ...
  def "test track memory mapped file"() {
    ...
    sample.getString("allocatingClass") == "org.codehaus.groovy.vmplugin.v8.IndyInterface"
    ...
    total.getString("allocatingClass") == "org.codehaus.groovy.vmplugin.v8.IndyInterface"
