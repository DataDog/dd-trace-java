...
public class URLCallSite {
  ...
  @CallSite.After("void java.net.URL.<init>(java.lang.String, java.lang.String, int, java.lang."
      + "String)")
  @CallSite.After("void java.net.URL.<init>(java.lang.String, java.lang.String, int, java.lang."
      + "String, java.net.URLStreamHandler)")
  ...
  @CallSite.After("void java.net.URL.<init>(java.net.URL, java.lang.String, java.net."
      + "URLStreamHandler)")
  public static URL afterCtor(
      @CallSite.AllArguments final Object[] args,
      @CallSite.Return @Nonnull final URL result
  ) {
