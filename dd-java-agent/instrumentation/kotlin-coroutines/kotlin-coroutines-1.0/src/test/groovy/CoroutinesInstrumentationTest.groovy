...
class CoroutinesInstrumentationTest extends AgentTestRunner {
  ...
  def "coroutine suspension should not mess up traces"() {
    setup:
    CoroutineTests kotlinTest = new CoroutineTests(ThreadPoolDispatcherKt.newSingleThreadContext("Single-Thread"))
