...
public class SourceCallSite {
  @CallSite.Before("scala.io.BufferedSource scala.io.Source$.fromFile(java.lang.String, scala.io."
      + "Codec)")
  @CallSite.Before("scala.io.BufferedSource scala.io.Source$.fromFile(java.lang.String, java."
      + "lang.String)")
  ...
  @CallSite.Before("scala.io.BufferedSource scala.io.Source$.fromFile(java.net.URI, scala.io.Codec)")
  @CallSite.Before("scala.io.BufferedSource scala.io.Source$.fromFile(java.net.URI, java.lang."
      + "String)")
  ...
  @CallSite.Before("scala.io.BufferedSource scala.io.Source$.fromURL(java.lang.String, java.lang."
      + "String)")
