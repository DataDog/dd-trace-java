...
public class FormFieldDirectivesInstrumentation extends InstrumenterModule.Iast
  ...
  public String[] knownMatchingTypes() {
    return new String[] {TRAIT_CLASS + "$class", TRAIT_CLASS};
  }
  ...
  public void methodAdvice(MethodTransformer transformer) {
    ...
    transformer.applyAdvice(
        isMethod()
          ...
          .and(takesArgument(0, named("akka.http.scaladsl.server.directives.FormFieldDirectives")))
          .and(
              takesArgument(
                  1,
  ...
  static class TaintSingleFormFieldDirectiveOldScalaAdvice {
    ...
    static void after(
      ...
      try {
        retval = retval.tmap(
            new TaintSingleParameterFunction<>(fmag),
