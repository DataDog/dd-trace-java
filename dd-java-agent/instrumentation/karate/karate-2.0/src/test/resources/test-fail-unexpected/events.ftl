[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "fail",
      "test.suite" : "[org/example/test_fail_unexpected] test fail unexpected",
      "test.type" : "test",
    ...
    "resource" : "[org/example/test_fail_unexpected] test fail unexpected",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "resource" : "[org/example/test_fail_unexpected] test fail unexpected.unexpected success",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
