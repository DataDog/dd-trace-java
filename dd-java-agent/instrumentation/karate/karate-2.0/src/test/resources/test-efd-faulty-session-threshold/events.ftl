[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "pass",
      "test.suite" : "[org/example/test_parameterized_more_cases] test parameterized",
      "test.type" : "test",
    ...
    "resource" : "[org/example/test_parameterized_more_cases] test parameterized",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "name" : "karate.test",
    "parent_id" : ${content_parent_id_8},
    "resource" : "[org/example/test_parameterized_more_cases] test parameterized.first scenario as an outline",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "resource" : "[org/example/test_parameterized_more_cases] test parameterized.first scenario as an outline",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
    "span_id" : ${content_parent_id_6},
    "start" : ${content_start_28},
    "test_module_id" : ${content_test_module_id},
    "test_session_id" : ${content_test_session_id},
    "test_suite_id" : ${content_test_suite_id},
    "trace_id" : ${content_trace_id_6}
  ...
  "content" : {
    ...
    "resource" : "[org/example/test_parameterized_more_cases] test parameterized.first scenario as an outline",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
    "span_id" : ${content_parent_id_7},
    "start" : ${content_start_29},
    "test_module_id" : ${content_test_module_id},
    "test_session_id" : ${content_test_session_id},
    "test_suite_id" : ${content_test_suite_id},
    "trace_id" : ${content_trace_id_7}
