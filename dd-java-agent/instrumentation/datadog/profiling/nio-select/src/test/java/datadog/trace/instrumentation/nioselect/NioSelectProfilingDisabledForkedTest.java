...
class NioSelectProfilingDisabledForkedTest extends AbstractInstrumentationTest {
  ...
  @Test
  @Timeout(30)
  void disabledTaskBlockGateLeavesNettySelectUninstrumented() throws InterruptedException {
