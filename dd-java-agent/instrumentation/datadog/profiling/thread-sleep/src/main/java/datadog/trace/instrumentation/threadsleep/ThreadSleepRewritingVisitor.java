...
/**
 * ASM visitor wrapper that wraps each {@code INVOKESTATIC java/lang/Thread.sleep(J)V} and {@code
 * java/lang/Thread.sleep(JI)V} call site in a TaskBlock capture/finish pair.
 *
...
public final class ThreadSleepRewritingVisitor implements AsmVisitorWrapper {
  ...
  static final class ThreadSleepClassVisitor extends ClassVisitor {
    ...
    public MethodVisitor visitMethod(
      ...
      return new ThreadSleepCallSiteMethodVisitor(access, descriptor, delegate);
    }
  }
}
