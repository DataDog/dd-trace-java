 ...
 * instrumented by this class. On those versions the JVMTI {@code MonitorWait}/{@code
 * MonitorWaited} callbacks in the native profiler emit the equivalent TaskBlock events; the gate
 * here keeps the two paths partition-disjoint to avoid double emission.
 *
