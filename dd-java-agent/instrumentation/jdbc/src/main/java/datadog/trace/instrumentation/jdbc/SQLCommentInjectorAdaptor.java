...
public class SQLCommentInjectorAdaptor implements AgentPropagation.Setter<SQLCommenter.Builder> {
  ...
  @Override
  public void set(SQLCommenter.Builder carrier, String key, String value) {
    ...
    if (key.equals(SAMPLING_PRIORITY)) {
      carrier.withSamplingPriority(Integer.valueOf(value));
    }
  }
}
