...
class SQLCommenterTest extends DDSpecification {
  ...
  def "test encode Sql Comment"() {
    ...
    "/*dde='Test',ddps='SqlCommenter'*/ SELECT * FROM foo"                                        | "service"     | DDTraceId.from(Long.MAX_VALUE) | 9876543210L | Integer.valueOf(0) | "/*dde='Test',ddps='SqlCommenter'*/ SELECT * FROM foo"
    ...
    "/*ddps='SqlCommenter'*/ SELECT * FROM foo"                                                   | "service"     | DDTraceId.from(Long.MAX_VALUE) | 9876543210L | Integer.valueOf(0) | "/*ddps='SqlCommenter'*/ SELECT * FROM foo"
    "/*ddpv='TestVersion'*/ SELECT * FROM foo"                                                    | "service"     | DDTraceId.from(Long.MAX_VALUE) | 9876543210L | Integer.valueOf(0) | "/*ddpv='TestVersion'*/ SELECT * FROM foo"
    "/*traceparen='missinglastchar'*/ SELECT * FROM foo"                                          | "service"     | DDTraceId.from(Long.MAX_VALUE) | 9876543210L | Integer.valueOf(0) | "/*dddbs='my-service',dde='Test',ddps='SqlCommenter',ddpv='TestVersion'*/ /*traceparen='missinglastchar'*/ SELECT * FROM foo"
