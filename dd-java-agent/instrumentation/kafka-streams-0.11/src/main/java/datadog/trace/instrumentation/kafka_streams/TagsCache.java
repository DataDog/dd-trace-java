...
public class TagsCache {
  ...
  public static final DDCache<String, String> TOPIC_TAG_CACHE =
      DDCaches.newFixedSizeCache(32);

  // Use new function instead of Functions.Prefix to keep return type as String instead of CharSequence.
  public static final Function<String, String> TOPIC_TAG_PREFIX = new StringPrefix("topic:");

  public static final DDCache<String, String> GROUP_TAG_CACHE =
      DDCaches.newFixedSizeCache(32);
