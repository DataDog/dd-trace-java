...
public class GradleBuildListener extends BuildAdapter {
  ...
  static final class TestTaskExecutionListener implements TaskExecutionListener {
    ...
    public void beforeExecute(@Nonnull Task task) {
      ...
      Map<String, Object> additionalTags = project.getPluginManager().hasPlugin("com.android.base")
      ...
      BuildModuleSettings moduleSettings = buildEventsHandler.onTestModuleStart(
          gradle, taskPath, moduleLayout, jvmExecutable, classpath, jacocoAgent, additionalTags);
