...
public class GradlePluginInjectorInstrumentation extends InstrumenterModule.CiVisibility
  ...
  public String[] helperClassNames() {
    return new String[] {
      ...
      packageName + ".AndroidGradleUtils$AndroidModuleLayout",
      packageName + ".AndroidGradleUtils$ClassDirectoriesFunction",
      packageName + ".AndroidGradleUtils$ClassJarsFunction",
      packageName + ".AndroidGradleUtils$ConfigureAndroidPluginAction",
      packageName + ".AndroidGradleUtils$ConfigureTestTaskFunction",
      packageName + ".AndroidGradleUtils$ConfigureVariantAction",
      packageName + ".AndroidGradleUtils",
      packageName + ".CiVisibilityGradleListener$AndroidProjectEvaluationListener",
