package datadog.trace.instrumentation.jackson_2_8.core;
...
import com.fasterxml.jackson.core.json.JsonParser28Helper;
...
public class JsonParserInstrumentation extends InstrumenterModule.Iast
  ...
  public String[] helperClassNames() {
    return new String[] {
      "com.fasterxml.jackson.core.json" + ".JsonParser28Helper",
      "com.fasterxml.jackson.core.sym" + ".ByteQuadsCanonicalizer28Helper",
    };
  }
    ...
    public static void onExit(@Advice.This JsonParser jsonParser, @Advice.Return String result) {
      if (jsonParser != null
        ...
        if (jsonParser instanceof UTF8StreamJsonParser
            && JsonParser28Helper.fetchIntern((UTF8StreamJsonParser) jsonParser)) {
