...
import com.fasterxml.jackson.core.json.Json2_8ParserHelper;
...
public class Json2_8ParserInstrumentation extends InstrumenterModule.Iast
  ...
  static final ElementMatcher.Junction<ClassLoader> VERSION_POST_2_8_0_AND_PRE_2_12_0 =
      hasClassNamed("com.fasterxml.jackson.core.JsonpCharacterEscapes")
          .and(not(hasClassNamed("com.fasterxml.jackson.core.StreamReadCapability")));

  public Json2_8ParserInstrumentation() {
    super("jackson", "jackson-2_8");
  }

  @Override
  public void methodAdvice(MethodTransformer transformer) {
    final String className = Json2_8ParserInstrumentation.class.getName();
  ...
  public String[] helperClassNames() {
    return new String[] {
      "com.fasterxml.jackson.core.json" + ".Json2_8ParserHelper",
      "com.fasterxml.jackson.core.sym" + ".ByteQuadsCanonicalizer2_8Helper",
    };
  }
    ...
    public static void onExit(@Advice.This JsonParser jsonParser, @Advice.Return String result) {
      if (jsonParser != null
        ...
        if (jsonParser instanceof UTF8StreamJsonParser
            && Json2_8ParserHelper.fetchIntern((UTF8StreamJsonParser) jsonParser)) {
