...
class Json2FactoryInstrumentationTest extends AgentTestRunner {
  ...
  void 'test createParser(String)'() {
    ...
    then:
    result != null
    1 * propagationModule.taintObjectIfTainted(_, _ as JsonParser, content)
    0 * _
  }
  ...
  void 'test createParser(InputStream)'() {
    ...
    then:
    result != null
    1 * propagationModule.taintObjectIfTainted(_, _ as JsonParser, is)
    2 * is.read(_, _, _)
    0 * _
  }
  ...
  void 'test createParser(Reader)'() {
    ...
    then:
    result != null
    1 * propagationModule.taintObjectIfTainted(_, _ as JsonParser, reader)
    0 * _
  }
  ...
  void 'test createParser(byte[])'() {
    ...
    then:
    result != null
    1 * propagationModule.taintObjectIfTainted(_, _ as JsonParser, bytes)
    0 * _
  }
  ...
  void 'test createParser(byte[], int, int)'() {
    ...
    then:
    parser != null
    1 * propagationModule.taintObjectIfRangeTainted(_, _ as JsonParser, bytes, 0, 2, false, VulnerabilityMarks.NOT_MARKED)
    0 * _
  }
  ...
  void 'test createParser(URL)'() {
    ...
    parser != null
    json == [key: 'value']
    1 * propagationModule.taintObjectIfTainted(_, _ as JsonParser, url)
    1 * propagationModule.findSource(_, _ as JsonParser) >> null
