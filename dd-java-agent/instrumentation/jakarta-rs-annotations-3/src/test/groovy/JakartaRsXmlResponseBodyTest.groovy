...
class JakartaRsXmlResponseBodyTest extends AgentTestRunner {
  ...
  def 'test XML response body parsing with simple XML'() {
    setup:
  ...
  def 'test XML response body parsing with attributes'() {
    setup:
  ...
  def 'test XML response body parsing with nested elements'() {
    setup:
    def xmlContent = '''
      <order>
        <customer>
  ...
  def 'test XML response body parsing with malformed XML returns null'() {
    setup:
