...
public class SampleCallSite {
  ...
  public static MessageDigest aroundMessageDigestGetInstance(
      @CallSite.Argument final String algorithm) throws NoSuchAlgorithmException {
    if (HANDLER != null) {
  ...
  public static void beforeStringConcat(
      @CallSite.This final String self, @CallSite.Argument final String value) {
    if (HANDLER != null) {
  ...
  public static URL afterURLInit(@CallSite.This URL result, @CallSite.Argument final String value) {
    if (HANDLER != null) {
