...
import datadog.trace.instrumentation.springsecurity5.AppSecDeferredContext;
...
/**
 * Instruments {@code SecurityContextHolderStrategy.setContext()} and {@code setDeferredContext()}
 * for Spring Security 7.x AppSec user tracking.
 */
