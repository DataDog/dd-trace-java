 ...
 * against a {@code PathMatchingHttpServletRequestWrapper}, which triggers {@code handleMatch} a
 * second time. The duplicate call is detected and skipped.
 */
public class HandleMatchAdvice {
  ...
  public static void after(
    ...
    if (req.getClass()
        .getName()
        .equals("datadog.trace.instrumentation.springweb7.PathMatchingHttpServletRequestWrapper")) {
      return;
    }
