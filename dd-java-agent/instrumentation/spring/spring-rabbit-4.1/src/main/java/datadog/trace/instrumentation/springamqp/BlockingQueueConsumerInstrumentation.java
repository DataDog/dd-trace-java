...
public class BlockingQueueConsumerInstrumentation extends InstrumenterModule.Tracing
  ...
  public Map<String, String> contextStore() {
    String stateClassName = State.class.getName();
    Map<String, String> contextStore = new TreeMap<>();
    contextStore.put("org.springframework.amqp.core.Message", stateClassName);
    contextStore.put("org.springframework.amqp.rabbit.support.Delivery", stateClassName);
    return contextStore;
  }
