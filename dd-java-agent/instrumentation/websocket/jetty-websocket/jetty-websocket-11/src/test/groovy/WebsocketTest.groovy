...
class WebsocketTest extends InstrumentationSpecification {
  ...
  def "test jetty advices with endpoint class #endpoint.class and message type #msgType"() {
    ...
    JakartaWebSocketServerFrameHandlerFactory factory = new JakartaWebSocketServerFrameHandlerFactory(new JakartaWebSocketServerContainer(new WebSocketMappings()))
