...
import static datadog.trace.instrumentation.websocket.jsr256.HandlersExtractor.BYTE_BUFFER_SIZE_CALCULATOR;
import static datadog.trace.instrumentation.websocket.jsr256.HandlersExtractor.CHAR_SEQUENCE_SIZE_CALCULATOR;
...
public class BasicRemoteEndpointInstrumentation
  ...
  public static class SendObjectAdvice {
    ...
    public static AgentScope before(
      ...
      // we actually assume that it's binary and that we cannot know the size.
