...
public class WebsocketServerInstrumentation
  ...
  public static class OnMessageAdvice {
    @Advice.OnMethodEnter(suppress = Throwable.class)
    public static AgentScope onEnter(
        @Advice.Argument(value = 0) WebSocket conn, @Advice.Argument(value = 1) Object message) {
      ...
      final AgentSpan wsSpan = SERVER_DECORATOR.onMessage(message, spanContext);
  ...
  public static class OnCloseAdvice {
    ...
    public static AgentScope onEnter(
      ...
      AgentSpanContext spanContext = context.getSpanContext();
      final AgentSpan wsSpan = SERVER_DECORATOR.onClose(code, message, remote, spanContext);
