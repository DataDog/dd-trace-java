...
class AWS0ClientTest extends AgentTestRunner {
  ...
  def "send #operation request with mocked response"() {
    ...
    "S3"    | "GetObject"         | "GET"  | "/someBucket/someKey" | 1            | new AmazonS3Client().withEndpoint("http://localhost:$server.address.port")  | ["aws.bucket.name": "someBucket", "bucketname": "someBucket", "aws.object.key": "someKey", "aws.object.versionId": "someVersion"] | { c -> c.getObject(new GetObjectRequest("someBucket", "someKey", "someVersion")) } | ""
