[ {
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "pass",
      "test.suite" : "org.example.TestSucceedMultiple",
      "test.type" : "test",
    ...
    "resource" : "org.example.TestSucceedMultiple",
  ...
  "content" : {
    ...
    "resource" : "org.example.TestSucceedMultiple.test_succeed",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "name" : "testng.test",
    "parent_id" : ${content_parent_id},
    "resource" : "org.example.TestSucceedMultiple.test_succeed_another",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
