[ {
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "skip",
      "test.suite" : "org.example.TestSkippedNested",
      "test.type" : "test",
    ...
    "resource" : "org.example.TestSkippedNested",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.source.file" : "dummy_source_path",
      "test.status" : "pass",
      "test.suite" : "org.example.TestSkippedNested$NestedSuite",
      "test.type" : "test",
      "test_session.name" : "session-name"
    },
    "metrics" : {
    ...
    "name" : "testng.test_suite",
    "resource" : "org.example.TestSkippedNested$NestedSuite",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "resource" : "org.example.TestSkippedNested$NestedSuite.test_succeed_nested",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "name" : "testng.test",
    "parent_id" : ${content_parent_id},
    "resource" : "org.example.TestSkippedNested.test_succeed",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
