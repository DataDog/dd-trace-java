[ {
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "fail",
      "test.suite" : "org.example.TestSucceedAndThenFail",
      "test.type" : "test",
    ...
    "resource" : "org.example.TestSucceedAndThenFail",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.is_new" : "true",
      "test.module" : "testng-7.0",
      "test.name" : "test_succeed_and_then_fail",
      "test.source.file" : "dummy_source_path",
      "test.source.method" : "test_succeed_and_then_fail()V",
      "test.status" : "pass",
      "test.suite" : "org.example.TestSucceedAndThenFail",
      "test.type" : "test",
      "test_session.name" : "session-name"
    ...
    "resource" : "org.example.TestSucceedAndThenFail.test_succeed_and_then_fail",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
