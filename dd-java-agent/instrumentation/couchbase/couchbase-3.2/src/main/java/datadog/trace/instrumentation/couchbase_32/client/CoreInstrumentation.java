    ...
    Instrumenter.HasMethodAdvice
{
  ...
  public String[] helperClassNames() {
    return new String[] {packageName + ".SeedNodeHelper", packageName + ".ConnectionStringHelper"};
  }
  ...
  public void methodAdvice(MethodTransformer transformer) {
    ...
    transformer.applyAdvice(
        isConstructor().and(
            takesArgument(2, named("com.couchbase.client.core.util.ConnectionString"))
        ),
  ...
  public static class CoreConstructorConnectionStringAdvice {
    @Advice.OnMethodExit
    public static void afterConstruct(
        @Advice.Argument(2) final ConnectionString connectionString,
        @Advice.This final Core core
    ) {
      InstrumentationContext
        .get(Core.class, String.class)
