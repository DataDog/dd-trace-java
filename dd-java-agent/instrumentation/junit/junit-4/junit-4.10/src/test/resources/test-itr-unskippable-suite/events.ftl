[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "pass",
      "test.suite" : "org.example.TestSucceedUnskippableSuite",
      "test.traits" : "{\"category\":[\"org.example.TestSucceedUnskippableSuite$datadog_itr_unskippable\"]}",
      "test.type" : "test",
      "test_session.name" : "session-name"
    },
    "metrics" : {
    ...
    "resource" : "org.example.TestSucceedUnskippableSuite",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "resource" : "org.example.TestSucceedUnskippableSuite.test_succeed",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
