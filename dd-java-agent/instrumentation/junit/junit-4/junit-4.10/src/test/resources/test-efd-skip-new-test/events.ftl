[ {
  ...
  "content" : {
    ...
    "resource" : "org.example.TestSucceedSkipEfd",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "pass",
      "test.suite" : "org.example.TestSucceedSkipEfd",
      "test.traits" : "{\"category\":[\"org.example.TestSucceedSkipEfd$datadog_efd_disable\"]}",
      "test.type" : "test",
      "test_session.name" : "session-name"
    },
    "metrics" : {
    ...
    "resource" : "org.example.TestSucceedSkipEfd.test_succeed",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
