    ...
    Instrumenter.HasMethodAdvice
{
  ...
  public void methodAdvice(MethodTransformer transformer) {
    transformer.applyAdvice(
        isConstructor(),
        JUnit4Instrumentation.class.getName() + "$HandlerAdvice"
    );
    transformer.applyAdvice(
  ...
  public static class HandlerAdvice {
    ...
    public static void onRunnerCreation(@Advice.This final Runner runner) {
      ...
      TestEventsHandlerHolder.start(
          ...
          JUnit4Utils.capabilities(false)
      );
    }
  }
  ...
  public static class JUnit4Advice {
    ...
    public static void addTracingListener(
      ...
      final TracingListener tracingListener = new JUnit4TracingListener(InstrumentationContext.get(
          Description.class,
