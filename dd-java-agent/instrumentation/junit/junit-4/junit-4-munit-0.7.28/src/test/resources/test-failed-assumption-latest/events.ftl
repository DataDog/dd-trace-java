[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "skip",
      "test.suite" : "org.example.TestFailedAssumptionMUnit",
      "test.type" : "test",
      "test_session.name" : "session-name"
    },
    "metrics" : {
    ...
    "resource" : "org.example.TestFailedAssumptionMUnit",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.skip_reason" : "this test always assumes the wrong thing",
      "test.source.file" : "dummy_source_path",
      "test.status" : "skip",
      "test.suite" : "org.example.TestFailedAssumptionMUnit",
      "test.type" : "test",
    ...
    "resource" : "org.example.TestFailedAssumptionMUnit.Calculator.add",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
