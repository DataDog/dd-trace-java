[ {
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "pass",
      "test.suite" : "classpath:org/example/cucumber/calculator/basic_arithmetic_unskippable_suite.feature:Basic Arithmetic",
      "test.type" : "test",
    ...
    "resource" : "classpath:org/example/cucumber/calculator/basic_arithmetic_unskippable_suite.feature:Basic Arithmetic",
  ...
  "content" : {
    ...
    "resource" : "classpath:org/example/cucumber/calculator/basic_arithmetic_unskippable_suite.feature:Basic Arithmetic.Addition",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
