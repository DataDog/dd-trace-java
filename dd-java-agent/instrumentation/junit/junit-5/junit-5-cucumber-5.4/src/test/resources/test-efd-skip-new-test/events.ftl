[ {
  "content" : {
    ...
    "resource" : "classpath:org/example/cucumber/calculator/basic_arithmetic_skip_efd.feature:Basic Arithmetic",
  ...
  "content" : {
    ...
    "resource" : "classpath:org/example/cucumber/calculator/basic_arithmetic_skip_efd.feature:Basic Arithmetic.Addition",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
