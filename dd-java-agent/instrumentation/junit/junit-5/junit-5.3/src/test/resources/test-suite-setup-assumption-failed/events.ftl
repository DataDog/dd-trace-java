[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "skip",
      "test.suite" : "org.example.TestSuiteSetUpAssumption",
      "test.type" : "test",
      "test_session.name" : "session-name"
    },
    "metrics" : {
    ...
    "resource" : "org.example.TestSuiteSetUpAssumption",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "resource" : "org.example.TestSuiteSetUpAssumption.test_succeed",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
