...
public class ExecutionRequestFactory {
  ...
  private static final BiFunction<ExecutionRequest, EngineExecutionListener, ExecutionRequest> EXECUTION_REQUEST_CREATE =
      createExecutionRequestHandle();

  private static BiFunction<ExecutionRequest, EngineExecutionListener, ExecutionRequest> createExecutionRequestHandle() {
  ...
  private static BiFunction<ExecutionRequest, EngineExecutionListener, ExecutionRequest> junit6Factory() {
  ...
  private static BiFunction<ExecutionRequest, EngineExecutionListener, ExecutionRequest> junit514Factory() {
  ...
  private static BiFunction<ExecutionRequest, EngineExecutionListener, ExecutionRequest> junit513Factory() {
  ...
  private static BiFunction<ExecutionRequest, EngineExecutionListener, ExecutionRequest> fallbackFactory() {
  ...
  private static MethodHandle findCreateMethod(String... parameterTypes) {
    return METHOD_HANDLES.method(ExecutionRequest.class, m -> "create".equals(m.getName())
