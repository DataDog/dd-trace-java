...
public class TestTaskHandle {
  ...
  public static final class MuzzleHelper implements ReferenceProvider {
    ...
    public static Collection<? extends Reference> compileReferences() {
      return Collections.singletonList(new Reference.Builder(TEST_TASK_CLASS)
        .withField(new String[0], 0, "testDescriptor", "Lorg/junit/platform/engine/TestDescriptor;")
        .withField(
            new String[0],
            0,
            "node",
            "Lorg/junit/platform/engine/support/hierarchical/Node;"
        )
        .withField(
            new String[0],
            0,
  ...
  public HierarchicalTestExecutorService.TestTask createRetryTask(
      ...
      EngineExecutionContext parentContext
  ) {
