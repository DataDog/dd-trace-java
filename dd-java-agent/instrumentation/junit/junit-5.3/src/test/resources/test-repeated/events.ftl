[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "pass",
      "test.suite" : "org.example.TestRepeated",
      "test.type" : "test",
      "test_session.name" : "session-name"
    },
    "metrics" : {
    ...
    "resource" : "org.example.TestRepeated",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.framework_version" : ${content_meta_test_framework_version},
      "test.module" : "junit-5.3",
      "test.name" : "test_repeated",
      "test.source.file" : "dummy_source_path",
      "test.source.method" : "test_repeated()V",
      "test.status" : "pass",
      "test.suite" : "org.example.TestRepeated",
      "test.type" : "test",
      "test_session.name" : "session-name"
    ...
    "resource" : "org.example.TestRepeated.test_repeated",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
