...
abstract class DefaultServerConnection36InstrumentationTest extends MongoBaseTest {
  @Shared
  MongoClient client
...
abstract class DefaultServerConnection36InstrumentationEnabledTest extends DefaultServerConnection36InstrumentationTest {
  @Override
...
abstract class DefaultServerConnection36InstrumentationDisabledTest extends DefaultServerConnection36InstrumentationTest {
...
class DefaultServerConnection36InstrumentationEnabledV0ForkedTest extends DefaultServerConnection36InstrumentationEnabledTest {
  @Override
  int version() {
    return 0
  }
...
class DefaultServerConnection36InstrumentationEnabledV1ForkedTest extends DefaultServerConnection36InstrumentationEnabledTest {
  @Override
  int version() {
    return 1
  }
...
// Test class with DBM propagation enabled by default
class DefaultServerConnection36InstrumentationDisabledV0Test extends DefaultServerConnection36InstrumentationDisabledTest {
  @Override
  int version() {
    return 0
  }
...
// Test class with service name mapping
class DefaultServerConnection36InstrumentationDisabledV1ForkedTest extends DefaultServerConnection36InstrumentationDisabledTest {
  @Override
  int version() {
    return 1
  }
