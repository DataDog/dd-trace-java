...
import static datadog.trace.bootstrap.instrumentation.api.InstrumentationTags.MESSAGING_OPERATION;
...
public final class JMSDecorator extends MessagingClientDecorator {
  ...
  public void onConsume(AgentSpan span, Message message, CharSequence resourceName) {
    onConsume(span, message, resourceName, null, "receive");
  }

  public void onConsume(
      AgentSpan span, Message message, CharSequence resourceName, String destinationName) {
    onConsume(span, message, resourceName, destinationName, "receive");
  }
  ...
  public void onConsume(
      ...
      String operation) {
    span.setTag(MESSAGING_SYSTEM, "jms");
    span.setTag(MESSAGING_OPERATION, operation);
  ...
  public void onProduce(AgentSpan span, CharSequence resourceName) {
    onProduce(span, resourceName, null);
  }

  public void onProduce(AgentSpan span, CharSequence resourceName, String destinationName) {
    span.setTag(MESSAGING_SYSTEM, "jms");
    span.setTag(MESSAGING_OPERATION, "send");
    if (null != resourceName) {
      span.setResourceName(resourceName);
    }
    if (null != destinationName && !destinationName.isEmpty()) {
