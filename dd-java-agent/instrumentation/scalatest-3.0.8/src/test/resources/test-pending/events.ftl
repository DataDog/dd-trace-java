[ {
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "skip",
      "test.suite" : "org.example.TestIgnoredPending",
      "test.type" : "test",
    ...
    "resource" : "org.example.TestIgnoredPending",
  ...
  "content" : {
    ...
    "resource" : "org.example.TestIgnoredPending.Example.add adds two numbers",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
