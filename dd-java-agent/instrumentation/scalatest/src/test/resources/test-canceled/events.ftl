[ {
  "content" : {
    ...
    "meta" : {
      ...
      "test.status" : "skip",
      "test.suite" : "org.example.TestIgnoredCanceled",
      "test.type" : "test",
    ...
    "resource" : "org.example.TestIgnoredCanceled",
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "test.skip_reason" : "4 did not equal 22",
      "test.source.file" : "dummy_source_path",
      "test.status" : "skip",
      "test.suite" : "org.example.TestIgnoredCanceled",
      "test.type" : "test",
    ...
    "resource" : "org.example.TestIgnoredCanceled.Example.add adds two numbers",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
