[ {
  ...
  "content" : {
    ...
    "meta" : {
      ...
      "error.type" : "org.scalatest.exceptions.TableDrivenPropertyCheckFailedException",
      "language" : "jvm",
      "library_version" : ${content_meta_library_version},
    ...
    "resource" : "org.example.TestFailedParameterized.addition should correctly add two numbers",
    "service" : "worker.org.gradle.process.internal.worker.gradleworkermain",
