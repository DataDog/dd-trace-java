...
class JSONObjectInstrumentationTest extends AgentTestRunner {
  ...
  void 'test JSONObject string constructor'() {
    ...
    2 * module.taintObjectIfTainted(_, "nameTest", _ as JSONObject)
    0 * _
  }
  ...
  void 'test JSONObject opt'() {
    ...
    2 * module.taintObjectIfTainted(_, _ as JSONObject, _ as JSONObject)
    1 * module.taintObjectIfTainted(_, _ as JSONTokener, json)
    1 * module.taintObjectIfTainted(_, "nameTest", _ as JSONObject)
    0 * _
  }
  ...
  void 'test JSONObject JSonTokenizer constructor'() {
    ...
    then:
    name == "nameTest"
    1 * module.taintObjectIfTainted(_, _ as JSONObject, _ as JSONTokener)
    1 * module.taintObjectIfTainted(_, _ as JSONTokener, json)
    2 * module.taintObjectIfTainted(_, "nameTest", _ as JSONObject)
    0 * _
  }
  ...
  void 'test JSONObject map constructor'(){
    ...
    then:
    1 * module.taintObjectIfTainted(_, _ as JSONObject, map)
    2 * module.taintObjectIfTainted(_, "nameTest", _ as JSONObject)
    0 * _
  }
}
