...
class ByteBufferTest extends AgentTestRunner {
  ...
  void 'test wrap method'() {
    ...
    then:
    1 * module.taintObjectIfTainted(_, _ as ByteBuffer, message, true, VulnerabilityMarks.NOT_MARKED)
  }
  ...
  void 'test array method'() {
    ...
    1 * module.taintObjectIfTainted(_, _ as byte[], message, true, VulnerabilityMarks.NOT_MARKED)
  }
}
