...
/**
 * Test-side bridge that fires the package-private {@code HttpServerResponseImpl.handleException} on
 * a Vert.x 3.x server response. Used by {@code server.RouteHandlerExceptionHandlerTest} to
