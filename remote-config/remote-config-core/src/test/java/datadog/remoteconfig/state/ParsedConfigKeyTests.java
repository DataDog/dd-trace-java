...
class ParsedConfigKeyTests {
  @TableTest({
    "scenario        | configKey                                                       ",
    "           | org      | version | product        | configId                       ",
    "                                                                                  ",
    "no version      | employee/ASM_DD/1.recommended.json/config                       ",
    "           | employee |         | ASM_DD         | 1.recommended.json             ",
    "                                                                                  ",
    "live debugging  | datadog/2/LIVE_DEBUGGING/Snapshot_1ba66cc9-146a-3479-9e66-      ",
    "2b63fd580f48/dog | datadog  | 2       | LIVE_DEBUGGING | Snapshot_1ba66cc9-146a-  ",
    "3479-9e66-2b63fd580f48                                                            ",
    "unknown product | datadog/2/NOT_REAL_PRODUCT/123/dogoz                            ",
    "           | datadog  | 2       | _UNKNOWN       | 123                            ",
    "                                                                                  "
  })
