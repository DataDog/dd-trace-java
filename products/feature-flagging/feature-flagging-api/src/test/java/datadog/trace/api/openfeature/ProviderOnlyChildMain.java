...
public final class ProviderOnlyChildMain {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    server.start();
    try {
      boolean agentGatewayAvailable = false;
      try {
        Class.forName("datadog.trace.api.featureflag.FeatureFlaggingGateway");
      ...
      System.setProperty(
          ...
          "http://127.0.0.1:" + server.getAddress().getPort() + "/config");
      System.setProperty("dd.feature.flags.configuration.source", "agentless");
      final Provider provider =
          new Provider(new Provider.Options().initTimeout(1, TimeUnit.SECONDS));
      ...
      System.out.println("AGENT_GATEWAY_AVAILABLE=" + agentGatewayAvailable);
