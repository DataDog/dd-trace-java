...
public final class JdkHttpClient implements HttpClient {
  ...
  public HttpResponse execute(HttpRequest request) throws IOException {
    ...
    try {
      java.net.http.HttpResponse<java.io.InputStream> jdkResponse =
          delegate.send(jdkRequest, java.net.http.HttpResponse.BodyHandlers.ofInputStream());
  ...
  public static final class JdkHttpClientBuilder implements HttpClient.Builder {
    ...
    public HttpClient build() {
      java.net.http.HttpClient jdkClient = delegate.build();
      return new JdkHttpClient(jdkClient);
    }
  }
}
