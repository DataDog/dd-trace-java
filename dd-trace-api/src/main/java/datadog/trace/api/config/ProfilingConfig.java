...
public final class ProfilingConfig {
  ...
  public static final String PROFILING_DATADOG_PROFILER_CPU_ENABLED = "profiling.ddprof.cpu.enabled";
  ...
  public static final int PROFILING_DATADOG_PROFILER_SAFEMODE_DEFAULT = POP_METHOD
      | LAST_JAVA_PC;
  ...
  public static final int PROFILING_DATADOG_PROFILER_LIVEHEAP_SAMPLE_PERCENT_DEFAULT =
      // default to 10% of allocation samples
  50;
  ...
  public static final int // 64MB default
  // 64MB default
  PROFILING_JFR_REPOSITORY_MAXSIZE_DEFAULT = 64 * 1024 * 1024;
  ...
  public static final String PROFILING_SMAP_COLLECTION_ENABLED = "profiling.smap.collection.enabled";
  ...
  public static final String PROFILING_TIMELINE_EVENTS_ENABLED = "profiling.timeline.events.enabled";
