...
public interface Tracer {
  ...
  /**
   * Returns the root span for the trace fragment to which the mutable span belongs. In the context of distributed tracing
   * this method returns the root span only for the fragment generated by the currently traced
   * application.
   *
   * @return The root span for the current trace fragment.
   ...
   * @param span
   * @throws IllegalArgumentException if passed object is null or not an OpenTelemetry or OpenTracing span
   */
