...
public class DDTags {
  ...
  public static final String DD_CODE_ORIGIN_EXIT_SPAN_FILE =
      DD_LD_PREFIX + "code_origin.exit_span.%d.file";

  public static final String DD_CODE_ORIGIN_EXIT_SPAN_SNAPSHOT_ID =
      DD_LD_PREFIX + "code_origin.exit_span.%d.snapshot_id";
