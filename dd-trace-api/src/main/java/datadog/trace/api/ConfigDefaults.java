...
public final class ConfigDefaults {
  ...
  // in seconds
  static final int DEFAULT_SCOPE_ITERATION_KEEP_ALIVE = 30;
  ...
  // seconds
  static final int DEFAULT_CLOCK_SYNC_PERIOD = 30;
  ...
  // ms
  static final int DEFAULT_LOGS_OTEL_INTERVAL = 1_000;
  // ms
  static final int DEFAULT_LOGS_OTEL_TIMEOUT = 30_000;
  ...
  // ms
  static final int DEFAULT_METRICS_OTEL_INTERVAL = 10_000;
  // Default recommended by Datadog; it differs from Otel’s  default of 30000 (30s)
  // ms
  static final int DEFAULT_METRICS_OTEL_TIMEOUT = 7_500;
  static final int DEFAULT_METRICS_OTEL_CARDINALITY_LIMIT = 2_000;
  // ms
  static final int DEFAULT_TRACE_STATS_INTERVAL = 10_000;
  public static final boolean DEFAULT_METRICS_OTEL_EXPERIMENTAL_ENABLED = true;
  // ms
  public static final int DEFAULT_OTLP_TRACES_TIMEOUT = 10_000;
  ...
  // seconds
  static final int DEFAULT_DOGSTATSD_START_DELAY = 15;
  ...
  // 0.1 s
  static final int DEFAULT_APPSEC_WAF_TIMEOUT = 100000;
  ...
  static final String DEFAULT_IAST_WEAK_CIPHER_ALGORITHMS =
      "^(?:PBEWITH(?:HMACSHA(?:2(?:24ANDAES_(?:128|256)|56ANDAES_(?:128|256))|384ANDAES_"
      + "(?:128|256)|512ANDAES_(?:128|256)|1ANDAES_(?:128|256))|SHA1AND(?:RC(?:2_(?:128|40)"
      + "|4_(?:128|40))|DESEDE)|MD5AND(?:TRIPLEDES|DES))|DES(?:EDE(?:WRAP)?)?"
      + "|BLOWFISH|ARCFOUR|RC2).*$";
  static final boolean DEFAULT_IAST_REDACTION_ENABLED = true;
  public static final String DEFAULT_IAST_REDACTION_NAME_PATTERN =
      "(?:p(?:ass)?w(?:or)?d|pass(?:_?phrase)?|secret|(?:api_?|private_?|public_?|access_"
      + "?|secret_?)key(?:_?id)?|token|consumer_?(?:id|key|secret)|sign(?:ed|ature)?|auth(?"
      + ":entication|orization)?)";
  public static final String DEFAULT_IAST_REDACTION_VALUE_PATTERN =
      "(?:bearer\\\\s+[a-z0-9\\\\._\\\\-]+|glpat-[\\\\w\\\\-]{20}|gh[opsu]_[0-9a-zA-Z]"
      + "{36}|ey[I-L][\\\\w=\\\\-]+\\\\.ey[I-L][\\\\w=\\\\-]+(?:\\\\.[\\\\w.+/=\\\\-]+)?|(?"
      + ":[\\\\-]{5}BEGIN[a-z\\\\s]+PRIVATE\\\\sKEY[\\\\-]{5}[^\\\\-]+[\\\\-]{5}END[a-"
      + "z\\\\s]+PRIVATE\\\\sKEY[\\\\-]{5}|ssh-rsa\\\\s*[a-z0-9/\\\\.+]{100,}))";
  ...
  // KiB
  static final int DEFAULT_REMOTE_CONFIG_MAX_PAYLOAD_SIZE = 5120;
  ...
  // seconds
  static final int DEFAULT_DYNAMIC_INSTRUMENTATION_UPLOAD_TIMEOUT = 30;
  // ms, 0 = dynamic
  static final int DEFAULT_DYNAMIC_INSTRUMENTATION_UPLOAD_FLUSH_INTERVAL = 0;
  static final boolean DEFAULT_DYNAMIC_INSTRUMENTATION_CLASSFILE_DUMP_ENABLED = false;
  // seconds
  static final int DEFAULT_DYNAMIC_INSTRUMENTATION_POLL_INTERVAL = 1;
  // seconds
  static final int DEFAULT_DYNAMIC_INSTRUMENTATION_DIAGNOSTICS_INTERVAL = 60 * 60;
  ...
  // KiB
  static final int DEFAULT_DYNAMIC_INSTRUMENTATION_MAX_PAYLOAD_SIZE = 1024;
  ...
  // milliseconds
  static final int DEFAULT_DYNAMIC_INSTRUMENTATION_CAPTURE_TIMEOUT = 100;
  // milliseconds
  static final int DEFAULT_DYNAMIC_INSTRUMENTATION_EVAL_TIMEOUT = 50;
  ...
  // nb of classes
  static final int DEFAULT_SYMBOL_DATABASE_FLUSH_THRESHOLD = 100;
  ...
  // seconds
  static final int DEFAULT_RESOLVER_RESET_INTERVAL = 300;
  static final boolean DEFAULT_TELEMETRY_ENABLED = true;
  // in seconds
  static final int DEFAULT_TELEMETRY_HEARTBEAT_INTERVAL = 60;
  static final int // 24 hours in seconds
  // 24 hours in seconds
  DEFAULT_TELEMETRY_EXTENDED_HEARTBEAT_INTERVAL = 24 * 60 * 60;
  // in seconds
  static final int DEFAULT_TELEMETRY_METRICS_INTERVAL = 10;
  ...
  // seconds
  static final long DEFAULT_TRACE_LONG_RUNNING_INITIAL_FLUSH_INTERVAL = 20;
  // seconds -> 2 minutes
  static final long DEFAULT_TRACE_LONG_RUNNING_FLUSH_INTERVAL = 120;
  static final float DEFAULT_TRACE_FLUSH_INTERVAL = 1;
  // 1 second
  static final long DEFAULT_TRACE_POST_PROCESSING_TIMEOUT = 1000;
  ...
  static final Set<String> DEFAULT_TRACE_CLOUD_PAYLOAD_TAGGING_SERVICES = new HashSet<>(Arrays.asList(
      "ApiGateway",
      "ApiGatewayV2",
      "EventBridge",
      "Sqs",
