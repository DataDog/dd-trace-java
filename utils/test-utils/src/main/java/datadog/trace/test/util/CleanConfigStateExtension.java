...
public class CleanConfigStateExtension implements BeforeAllCallback, AfterAllCallback {
  ...
  private static void assertClean(String phase) {
    Map<String, String> leakedEnv = filterMap(EnvironmentVariables.getAll(), DATADOG_ENV_VAR_FILTER);
    Map<Object, Object> leakedSys = filterMap(System.getProperties(), DATADOG_SYS_PROPERTIES_FILTER);
