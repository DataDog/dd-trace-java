...
public interface TimeSource {
  /**
   * Returns monatonically increasing ticks from some arbitrary start point.
   * Should only be used to measure durations.
   * Negative numbers and zero are both valid return values
   */
  long getNanoTicks();
   ...
   * Valid for the time range 1/1/1970 +/- 270 years
   */
