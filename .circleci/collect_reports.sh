...
function save_reports () {
    ...
    cp -r workspace/$project_to_save/build/core* $report_path/
    cp -r workspace/$project_to_save/build/hs_err_pid* $report_path/
    cp -r workspace/$project_to_save/build/replay* $report_path/
}
