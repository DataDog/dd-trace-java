...
class TraceMapperRealAgentTest extends AbstractTraceAgentTest {
  ...
  def setup() {
    ...
    v05Discovery = new DDAgentFeaturesDiscovery(client, monitoring, agentUrl, true, true, false)
    v04Discovery = new DDAgentFeaturesDiscovery(client, monitoring, agentUrl, false, true, false)
