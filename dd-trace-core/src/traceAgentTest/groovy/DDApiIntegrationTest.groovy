...
class DDApiIntegrationTest extends AbstractTraceAgentTest {
  ...
  def beforeTest(boolean enableV05) {
    ...
    discovery = new DDAgentFeaturesDiscovery(httpClient, monitoring, agentUrl, enableV05, true, false)
    ...
    udsDiscovery = new DDAgentFeaturesDiscovery(udsClient, monitoring, agentUrl, enableV05, true, false)
