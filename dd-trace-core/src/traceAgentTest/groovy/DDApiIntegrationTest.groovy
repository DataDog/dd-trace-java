...
class DDApiIntegrationTest extends DDSpecification {
  ...
  def beforeTest(boolean enableV05) {
    ...
    discovery = new DDAgentFeaturesDiscovery(httpClient, monitoring, agentUrl, enableV05, true,true)
    ...
    udsDiscovery = new DDAgentFeaturesDiscovery(udsClient, monitoring, agentUrl, enableV05, true,true)
