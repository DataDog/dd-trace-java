...
class W3CHttpInjectorTest extends AbstractHttpInjectorTest {
  ...
  @TableTest({
    ...
    "tracestate                                                                       ",
    "unset 1->2              | 1       | 2      | UNSET            |        | 'dd=p:  ",
    "0000000000000002;t.usr:123'                                                      ",
    "keep 1->4 saipan        | 1       | 4      | SAMPLER_KEEP     | saipan | 'dd=s:1;",
    "o:saipan;p:0000000000000004;t.usr:123'                                           ",
    "unset max->max-1 saipan | MAX     | MAX-1  | UNSET            | saipan | 'dd=o:  ",
    "saipan;p:fffffffffffffffe;t.usr:123'                                             ",
    "keep max-1->max         | MAX-1   | MAX    | SAMPLER_KEEP     |        | 'dd=s:1;",
    "p:ffffffffffffffff;t.usr:123'                                                    ",
    "drop max-1->max         | MAX-1   | MAX    | SAMPLER_DROP     |        | 'dd=s:0;",
    "p:ffffffffffffffff;t.usr:123'                                                    "
  })
  ...
  void injectHttpHeadersWithEndToEnd() {
    ...
    expected.put(
        ...
        String.valueOf(mockedContext.getEndToEndStartTime() / 1000000L)
    );
    expected.put(OT_BAGGAGE_PREFIX + "k1", "v1");
    expected.put(OT_BAGGAGE_PREFIX + "k2", "v2");
    assertEquals(expected, carrier);
