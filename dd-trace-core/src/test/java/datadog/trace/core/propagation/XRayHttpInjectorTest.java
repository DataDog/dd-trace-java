...
class XRayHttpInjectorTest extends AbstractHttpInjectorTest {
  ...
  @TableTest({
    ...
    "                                                                                  ",
    "                                                                                  ",
    "unset 1->2       | 1       | 2      | UNSET            | 'Root=1-633c7675-        ",
    "000000000000000000000001;Parent=0000000000000002;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     ",
    "keep 2->3        | 2       | 3      | SAMPLER_KEEP     | 'Root=1-633c7675-        ",
    "000000000000000000000002;Parent=0000000000000003;Sampled=1;_dd.origin=fakeOrigin; ",
    "SOME_CUSTOM_HEADER=some-value;k=v'                                                ",
    "drop 4->5        | 4       | 5      | SAMPLER_DROP     | 'Root=1-633c7675-        ",
    "000000000000000000000004;Parent=0000000000000005;Sampled=0;_dd.origin=fakeOrigin; ",
    "SOME_CUSTOM_HEADER=some-value;k=v'                                                ",
    "user keep 5->6   | 5       | 6      | USER_KEEP        | 'Root=1-633c7675-        ",
    "000000000000000000000005;Parent=0000000000000006;Sampled=1;_dd.origin=fakeOrigin; ",
    "SOME_CUSTOM_HEADER=some-value;k=v'                                                ",
    "user drop 6->7   | 6       | 7      | USER_DROP        | 'Root=1-633c7675-        ",
    "000000000000000000000006;Parent=0000000000000007;Sampled=0;_dd.origin=fakeOrigin; ",
    "SOME_CUSTOM_HEADER=some-value;k=v'                                                ",
    "unset max->max-1 | MAX     | MAX-1  | UNSET            | 'Root=1-633c7675-        ",
    "00000000ffffffffffffffff;Parent=fffffffffffffffe;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     ",
    "keep max-1->max  | MAX-1   | MAX    | SAMPLER_KEEP     | 'Root=1-633c7675-        ",
    "00000000fffffffffffffffe;Parent=ffffffffffffffff;Sampled=1;_dd.origin=fakeOrigin; ",
    "SOME_CUSTOM_HEADER=some-value;k=v'                                                "
  })
  ...
  @TableTest({
    ...
    "                                                                                  ",
    "                                                                                  ",
    "short ids      | 00001            | 00001            | 'Root=1-633c7675-          ",
    "000000000000000000000001;Parent=0000000000000001;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     ",
    "long ids same  | 463ac35c9f6413ad | 463ac35c9f6413ad | 'Root=1-633c7675-          ",
    "00000000463ac35c9f6413ad;Parent=463ac35c9f6413ad;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     ",
    "long trace     | 48485a3953bb6124 | 1                | 'Root=1-633c7675-          ",
    "0000000048485a3953bb6124;Parent=0000000000000001;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     ",
    "max trace id   | ffffffffffffffff | 1                | 'Root=1-633c7675-          ",
    "00000000ffffffffffffffff;Parent=0000000000000001;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     ",
    "mixed trace id | aaaaaaaaffffffff | 1                | 'Root=1-633c7675-          ",
    "00000000aaaaaaaaffffffff;Parent=0000000000000001;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     ",
    "max span id    | 1                | ffffffffffffffff | 'Root=1-633c7675-          ",
    "000000000000000000000001;Parent=ffffffffffffffff;_dd.origin=fakeOrigin;SOME_      ",
    "CUSTOM_HEADER=some-value;k=v'                                                     "
  })
  ...
  void injectHttpHeadersWithEndToEnd() {
    ...
    String expectedTraceHeader =
        "Root=1-633c7675-000000000000000000000001;Parent=0000000000000002;_dd."
        + "origin=fakeOrigin;t0=1664906869196;k=v";
    assertEquals(1, carrier.size());
    assertEquals(expectedTraceHeader, carrier.get(X_AMZN_TRACE_ID));
  }
