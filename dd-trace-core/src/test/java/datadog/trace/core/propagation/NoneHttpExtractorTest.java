...
class NoneHttpExtractorTest extends DDCoreSpecification {
  ...
  HttpCodec.Extractor createExtractor(Config config) {
    return NoneCodec.newExtractor(config, () -> dynamicConfig.captureTraceConfig());
  }
  ...
  static Stream<Arguments> extractHttpHeadersArguments() {
    ...
    return Stream.of(
        ...
        Arguments.of("2", "3", PrioritySampling.UNSET, null, false),
        Arguments.of(maxStr, maxMinus1Str, PrioritySampling.UNSET, null, true),
        Arguments.of(maxMinus1Str, maxStr, PrioritySampling.UNSET, null, false));
  }
  ...
  void extractHeaderTagsWithNoPropagationWithoutOrigin() {
    ...
    assertNull(((TagContext) context).getOrigin());
  }
