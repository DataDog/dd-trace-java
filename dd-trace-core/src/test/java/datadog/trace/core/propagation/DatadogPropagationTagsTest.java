...
class DatadogPropagationTagsTest extends DDJavaSpecification {
  ...
  @TableTest({
    ...
    "llmobs parent ids                 | '_dd.p.llmobs_pagent_span_id=9876543210,_dd.p.llmobs_parent_id=1122334455'                                                   | '_dd.p.llmobs_parent_id=1122334455,_dd.p.llmobs_pagent_span_id=9876543210' | [_dd.p.llmobs_pagent_span_id: '9876543210', _dd.p.llmobs_parent_id: '1122334455']",
  ...
  @TableTest({
    ...
    "all five propagate          | 'my-ml-app'    | 'sess-1'  | '9876543210' | 'planner'   | '1122334455' | '_dd.p.llmobs_parent_id=1122334455,_dd.p.llmobs_ml_app=my-ml-app,_dd.p.llmobs_sid=sess-1,_dd.p.llmobs_pagent_span_id=9876543210,_dd.p.llmobs_pagent_name=planner'",
