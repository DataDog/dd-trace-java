...
class SystemAccessTest extends DDJavaSpecification {
  ...
  @TableTest({
    "scenario                               | providerEnabled | profilingEnabled | ",
    "healthMetricsEnabled | hasCpuTime                                             ",
    "all disabled                           | false           | false            | ",
    "false                | false                                                  ",
    "health metrics only                    | false           | false            | ",
    "true                 | false                                                  ",
    "profiling only                         | false           | true             | ",
    "false                | false                                                  ",
    "profiling and health metrics           | false           | true             | ",
    "true                 | false                                                  ",
    "provider only                          | true            | false            | ",
    "false                | false                                                  ",
    "provider and health metrics            | true            | false            | ",
    "true                 | true                                                   ",
    "provider and profiling                 | true            | true             | ",
    "false                | true                                                   ",
    "provider, profiling and health metrics | true            | true             | ",
    "true                 | true                                                   "
  })
  void testCpuTime(
