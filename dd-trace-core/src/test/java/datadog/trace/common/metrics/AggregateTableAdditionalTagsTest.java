...
class AggregateTableAdditionalTagsTest {
  ...
  void overlongValuesShareTheBlockedSentinelEntry() {
    ...
    assertEquals(1, table.size());
    assertEquals(
        "region:blocked_by_tracer", first.getAdditionalTags()[0].toString());
  }
  ...
  void cardinalityCapCollapsesNewEntriesToBlockedSentinel() {
    ...
    assertEquals(
        "region:blocked_by_tracer", third.getAdditionalTags()[0].toString());
  ...
  void cardinalityCapDoesNotBlockExistingEntries() {
    ...
    assertEquals(
        "region:blocked_by_tracer", blocked.getAdditionalTags()[0].toString());
  }
