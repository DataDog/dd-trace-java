...
class DDIntakeTrackTypeResolverTest extends DDJavaSpecification {
  @TableTest({
    "scenario                           | ciVisibilityEnabled |                        ",
    "ciVisibilityAgentlessEnabled | expectedTrackType                                  ",
    "ci-vis disabled agentless disabled | false               | false                  ",
    "      | NOOP                                                                      ",
    "ci-vis enabled agentless disabled  | true                | false                  ",
    "      | CITESTCYCLE                                                               ",
    "ci-vis enabled agentless enabled   | true                | true                   ",
    "      | CITESTCYCLE                                                               "
  })
