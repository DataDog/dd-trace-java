...
class JsonPathTest extends Specification {
  ...
  def "matching"() {
    ...
    p().name("foo").any().name("baz").build()       | p().name("foo").name("bar").name("baz").build()
    p().name("foo").any().name("baz").build()       | p().name("foo").index(42).name("baz").build()
    p().any().build()                               | p().name("phoneNumbers").build()
    p().any().any().build()                         | p().name("foo").name("bar").build()
    p().name("keys").index(3).build()               | p().name("keys").index(3).build()
    p().name("keys").index(3).name("b").build()     | p().name("keys").index(3).name("b").build()
    p().search().name("password").build()        | p().name("foo").name("bar").index(33).name("password").build()
    p().name("foo").search().name("bar").build() | p().name("foo").name("bar").build()
    p().name("foo").search().name("bar").build() | p().name("foo").name("bar").index(33).name("bar").build()
    p().name("foo").search().name("bar").build() | p().name("foo").name("bar").index(33).name("bar").build()
    p().name("foo").search().name("bar").build() | p().name("foo").name("bar").index(33).name("bar").build()
    p().name("foo").search().name("bar").build() | p().name("foo").name("baz").index(33).name("bar").build()
    p().search().name("number").search()
      .name("area").search()
  ...
  def "non matching"() {
    ...
    p().name("foo").any().build()                   | p().name("bar").name("baz").build()
    p().name("foo").any().name("baz").build()       | p().name("Foo").name("bar").name("baz").build()
    p().name("foo").any().name("baz").build()       | p().name("foo").name("bar").name("Baz").build()
    p().name("foo").any().name("baz").build()       | p().name("foo").name("bar").index(3).name("baz").build()
    p().name("foo").any().name("baz").build()       | p().name("foo").name("bar").name("bar").name("baz").build()
    p().any().build()                               | p().name("foo").name("bar").build()
    p().any().any().build()                         | p().name("foo").build()
    p().any().any().build()                         | p().name("foo").name("bar").name("baz").build()
    ...
    p().search().name("password").build()        | p().name("foo").name("bar").index(33).name("Password").build()
    p().name("foo").search().name("bar").build() | p().name("foo").name("bar").index(33).name("baz").build()
    p().search().name("number").search()
      .name("AREA").search()
      .name("code").build()                      | p().name("number").name("area").name("code").build()
    p().search().name("number").search()
  ...
  def "print normalized json path"() {
    ...
    where:
    pattern                                                           | normalized
    p().name("phoneNumbers").any().name("number").build()                | '''$['phoneNumbers'][*]['number']'''
    p().name("phoneNumbers").any().name("number").build()                | '''$['phoneNumbers'][*]['number']'''
    p().name("phoneNumbers").any().name("number").build()                | '''$['phoneNumbers'][*]['number']'''
    p().search().name("number").build()                                  | '''$..['number']'''
    p().name("foo").search().name("bar").search().name("number").build() | '''$['foo']..['bar']..['number']'''
  ...
  def "print json path in dot notation with a custom prefix"() {
    ...
    where:
    pattern                                                           | expected
    p().name("phoneNumbers").any().name("number").build()                | 'dd.phoneNumbers.*.number'
    p().search().name("number").build()                                  | 'dd..number'
    p().name("foo").search().name("bar").search().name("number").build() | 'dd.foo..bar..number'
