...
class HttpEndpointTaggingTest extends DDSpecification {
  ...
  def "should preserve static segments"() {
    ...
    HttpEndpointTagging.parameterizeUrlPath("/api/v1/status") == "/api/v1/status"
    HttpEndpointTagging.parameterizeUrlPath("/static/css/styles.css") == "/static/css/styles.css"
  }
