...
class MonitorTest extends DDSpecification {
  ...
  def "test onShutdown"() {
    ...
    when:
    monitor.onShutdown(writer, true)
  ...
  def "test onPublish"() {
    ...
    when:
    monitor.onPublish(writer, trace)
  ...
  def "test onFailedPublish"() {
    ...
    when:
    monitor.onFailedPublish(writer, trace)
  ...
  def "test onScheduleFlush"() {
    ...
    when:
    monitor.onScheduleFlush(writer, true)
