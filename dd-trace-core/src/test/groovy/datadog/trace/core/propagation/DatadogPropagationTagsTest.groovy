...
class DatadogPropagationTagsTest extends DDCoreSpecification {
  ...
  def "create propagation tags from header value '#headerValue'"() {
    ...
    "_dd.p.tid=" + "1" * 1                                                                                                       | null                                       | ["_dd.propagation_error": "decoding_error"] // invalid tid tag value: invalid length
    "_dd.p.tid=" + "1" * 15                                                                                                      | null                                       | ["_dd.propagation_error": "decoding_error"] // invalid tid tag value: invalid length
    "_dd.p.tid=" + "1" * 17                                                                                                      | null                                       | ["_dd.propagation_error": "decoding_error"] // invalid tid tag value: invalid length
    "_dd.p.tid=123456789ABCDEF0"                                                                                                 | null                                       | ["_dd.propagation_error": "decoding_error"] // invalid tid tag value: upper-case characters
    "_dd.p.tid=123456789abcdefg"                                                                                                 | null                                       | ["_dd.propagation_error": "decoding_error"] // invalid tid tag value: non-hexadecimal characters
    "_dd.p.tid=-123456789abcdef"                                                                                                 | null                                       | ["_dd.propagation_error": "decoding_error"] // invalid tid tag value: non-hexadecimal characters
  }
