...
class DependencyResolverSpecification extends DepSpecification {
  ...
  void 'resolve from manifest and filename fallbacks'() {
    ...
    'com.github.ben-manes.caffeine'             | 'com.github.ben-manes.caffeine' | '2.8.5'                    | null                              | null                  | 'caffeine-2.8.5.jar'               || 'caffeine'                   | '2.8.5'
    ...
    'org.freemarker.freemarker'                 | 'org.freemarker.freemarker'     | '2.3.27.stable-incubating' | 'FreeMarker'                      | '2.3.27'              | 'freemarker-2.3.27-incubating.jar' || 'freemarker'                 | '2.3.27-incubating'
    ...
    'org.hsqldb.hsqldb'                         | 'HSQLDB'                        | '2.3.5'                    | 'Standard runtime'                | '2.3.5'               | 'hsqldb-2.3.5-jdk6debug.jar'       || 'hsqldb'                     | '2.3.5-jdk6debug'
    'org.glassfish.hk2.external.jakarta.inject' | 'javax.inject:1 as OSGi bundle' | '2.6.1'                    | null                              | null                  | 'jakarta.inject-2.6.1.jar'         || 'jakarta.inject'             | '2.6.1'
    ...
    'com.opencsv'                               | 'opencsv'                       | '4.1.0'                    | null                              | null                  | 'opencsv-4.1.jar'                  || 'com:opencsv'                | '4.1'
    'org.liquibase.core'                        | 'liquibase-core'                | '0.0.0.SNAPSHOT'           | null                              | null                  | 'liquibase-core-4.6.2.jar'         || 'org:liquibase-core'         | '4.6.2'
    'org.roaringbitmap.RoaringBitmap'           | 'RoaringBitmap'                 | '0.0.1'                    | null                              | null                  | 'RoaringBitmap-0.0.1.jar'          || 'RoaringBitmap'              | '0.0.1'
