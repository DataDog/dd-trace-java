...
public final class PidHelper {
  ...
  private static String findPid() {
    ...
    if (JavaVirtualMachine.isJavaVersionAtLeast(9)) {
      try {
        pid = ((Supplier<String>) Class
          .forName("datadog.trace.util.JDK9PidSupplier")
  ...
  private static String getTempDir() {
    if (!JavaVirtualMachine.isJ9()) {
      ...
      try {
        // github.com/eclipse-openj9/openj9/blob/196082df056a990756a5571bfac29585fbbfbb42/jcl/src/java.base/share/classes/openj9/internal/tools/attach/target/IPC.java#L351
        https: return (String) Class
          .forName("openj9.internal.tools.attach.target.IPC")
