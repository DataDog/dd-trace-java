 ...
 * <b>stateless</b> subclass held by each caller as a {@code static final} field <i>declared with the
 * concrete helper type</i> (not the {@code Helper} base):
 *
 * <pre>{@code
 ...
 * / a live-size counter are <b>caller policy</b> (this class is pure mechanism): a capped caller does
...
public final class FlatHashtable {
  ...
  /**
   * Per-use policy. Extend as a <b>stateless</b> final class and hold a {@code static final} singleton
