...
public class HardcodedSecretMatcher {
  ...
  public static final HardcodedSecretMatcher AGE_SECRET_KEY = new HardcodedSecretMatcher(
      "age-secret-key", Pattern.compile("AGE-SECRET-KEY-1[QPZRY9X8GF2TVDW0S3JN54KHCE6MUA7L]{58}"));
  ...
  public static final HardcodedSecretMatcher CLOJARS_API_TOKEN = new HardcodedSecretMatcher(
  ...
  public static final HardcodedSecretMatcher SENDGRID_API_TOKEN = new HardcodedSecretMatcher(
      "sendgrid-api-token",
      Pattern.compile("(?i)\\b(SG\\.(?i)[a-z0-9=_\\-\\.]{66})(?:['|\"\"|\\n|\\r|\\s|\\x60|;]|$)"));
