...
public abstract class InstrumentationBridge {
  ...
  public static volatile XContentTypeOptionsModule X_CONTENT_TYPE_OPTIONS_HEADER_MODULE;
  ...
  public static void registerIastModule(final IastModule module) {
    ...
    } else if (module instanceof XContentTypeOptionsModule) {
      X_CONTENT_TYPE_OPTIONS_HEADER_MODULE = (XContentTypeOptionsModule) module;
  ...
  public static <E extends IastModule> E getIastModule(final Class<E> type) {
    ...
    if (type == XContentTypeOptionsModule.class) {
      return (E) X_CONTENT_TYPE_OPTIONS_HEADER_MODULE;
    }
  ...
  public static void clearIastModules() {
    ...
    X_CONTENT_TYPE_OPTIONS_HEADER_MODULE = null;
