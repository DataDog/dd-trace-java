...
public enum IastMetric {
  ...
  /** Value of the metric tag ready to be used by the telemetry intake (name : value). */
  ...
  /** Value of the metric tag ready to be used in spans */
