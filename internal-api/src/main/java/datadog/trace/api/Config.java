...
import static datadog.trace.api.config.TraceInstrumentationConfig.ASYNC_TRANSFORMATION_ENABLED;
...
public class Config {
  ...
  private final boolean asyncTransformationEnabled;
  ...
  private Config(final ConfigProvider configProvider) {
    ...
    asyncTransformationEnabled = configProvider.getBoolean(ASYNC_TRANSFORMATION_ENABLED, true);
  ...
  public boolean isAsyncTransformationEnabled() {
    return asyncTransformationEnabled;
  }
