...
public final class Events<D> {
   ...
   */
  @SuppressWarnings("unchecked")
  public EventType<TriFunction<RequestContext, String, /* method */
  URIDataAdapter, Flow<Void>>> requestMethodUriRaw() {
    return (EventType<TriFunction<RequestContext, String, URIDataAdapter, Flow<Void>>>) REQUEST_METHOD_URI_RAW;
  }
  ...
  public EventType<TriFunction<RequestContext, String, Integer, Flow<Void>>> requestClientSocketAddress() {
    return (EventType<TriFunction<RequestContext, String, Integer, Flow<Void>>>) REQUEST_CLIENT_SOCKET_ADDRESS;
  }
  ...
  public EventType<BiFunction<RequestContext, String, Flow<Void>>> requestInferredClientAddress() {
    return (EventType<BiFunction<RequestContext, String, Flow<Void>>>) REQUEST_INFERRED_CLIENT_ADDRESS;
  }
  ...
  public EventType<BiFunction<RequestContext, StoredBodySupplier, Flow<Void>>> requestBodyDone() {
    return (EventType<BiFunction<RequestContext, StoredBodySupplier, Flow<Void>>>) REQUEST_BODY_DONE;
  }
  ...
  public EventType<BiFunction<RequestContext, HttpClientRequest, Flow<Void>>> httpClientRequest() {
    return (EventType<BiFunction<RequestContext, HttpClientRequest, Flow<Void>>>) HTTP_CLIENT_REQUEST;
  }
  ...
  public EventType<BiFunction<RequestContext, HttpClientResponse, Flow<Void>>> httpClientResponse() {
    return (EventType<BiFunction<RequestContext, HttpClientResponse, Flow<Void>>>) HTTP_CLIENT_RESPONSE;
  }
  ...
  public EventType<BiFunction<RequestContext, List<String>, Flow<Void>>> requestFilesFilenames() {
    return (EventType<BiFunction<RequestContext, List<String>, Flow<Void>>>) REQUEST_FILES_FILENAMES;
  }
