 ...
 * is global static; {@code TagMapAccessBenchmark} registers one in its own forks).
 */
...
public class TagMapAccessBaselineBenchmark {
  // same tag set as TagMapAccessBenchmark for an apples-to-apples comparison
  static final String[] NAMES = TagMapAccessBenchmark.NAMES;
