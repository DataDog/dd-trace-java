...
class NamingV0ForkedTest extends DDSpecification {
  def "v0 should use DD_SERVICE when DD_TRACE_REMOVE_CLIENT_SERVICE_NAMES_ENABLED is true"() {
    setup:
    def ddService = "testService"
    injectSysConfig(TracerConfig.TRACE_REMOVE_CLIENT_SERVICE_NAMES_ENABLED, "true")
