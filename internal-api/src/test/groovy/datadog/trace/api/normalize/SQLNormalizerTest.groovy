...
class SQLNormalizerTest extends DDSpecification {
  ...
  def "test normalize #sql"() {
    when:
    UTF8BytesString normalized = SQLNormalizer.normalize(sql, true)
    then:
    ...
    "/*dddbs='my-service',dde='Test'*/ 罿潯罿潯罿潯罿潯罿潯"                                                                              | "罿潯罿潯罿潯罿潯罿潯"
    "SELECT * FROM TABLE WHERE userId = 'abc1287681964'"                                                                             | "SELECT * FROM TABLE WHERE userId = ?"
    "/*dddbs='my-service',dde='Test'*/ SELECT * FROM TABLE WHERE userId = 'abc1287681964'"                                      | "SELECT * FROM TABLE WHERE userId = ?"
    ...
    "SELECT * FROM TABLE WHERE userId = 'abc\\'1287\\'681\\'\\'\\'\\'964'"                                                           | "SELECT * FROM TABLE WHERE userId = ?"
    "/*dddbs='my-service',dde='Test'*/ SELECT * FROM TABLE WHERE userId = 'abc\\'1287\\'681\\'\\'\\'\\'964'"                    | "SELECT * FROM TABLE WHERE userId = ?"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT * FROM TABLE WHERE userId IN (\'abc\\'1287681\\'964\', \'abc\\'1287\\'681\\'\\'\\'\\'964\', \'abc\\'1287\\'681\\'964\')" | "SELECT * FROM TABLE WHERE userId IN (?, ?, ?)"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT * FROM TABLE WHERE userId = 'abc\\'1287\\'681\\'\\'\\'\\'964' ORDER BY FOO DESC"                                         | "SELECT * FROM TABLE WHERE userId = ? ORDER BY FOO DESC"
    ...
    "/*dddbs='my-service',dde='Test'*/ CREATE TABLE \"VALUE\""                                                                                                         | "CREATE TABLE \"VALUE\""
    " /*dddbs='my-service',dde='Test'*/INSERT INTO \"VALUE\" (\"column\") VALUES (\'ljahklshdlKASH\')"                                                                 | "INSERT INTO \"VALUE\" (\"column\") VALUES (?)"
    ...
    "/*dddbs='my-service',dde='Test'*/ INSERT INTO \"VALUE\" (\"col1\",\"col2\",\"col3\") VALUES (\'blah\',12983,X'ff')"                                               | "INSERT INTO \"VALUE\" (\"col1\",\"col2\",\"col3\") VALUES (?,?,?)"
    "INSERT INTO \"VALUE\" (\"col1\", \"col2\", \"col3\") VALUES (\'blah\',12983,X'ff')"                                             | "INSERT INTO \"VALUE\" (\"col1\", \"col2\", \"col3\") VALUES (?,?,?)"
    "INSERT INTO VALUE (col1,col2,col3) VALUES (\'blah\',12983,X'ff')"                                                               | "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    ...
    "/*dddbs='my-service',dde='Test'*/ INSERT INTO VALUE (col1,col2,col3) VALUES (X'ff',\'blah\',12983)"                                                               | "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    "/*dddbs='my-service',dde='Test'*/ INSERT /* my-comment that should  not be removed*/ INTO VALUE (col1,col2,col3) VALUES (X'ff',\'blah\',12983)"                                                               | "INSERT /* my-comment that should  not be removed*/ INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    "INSERT INTO VALUE (col1,col2,col3) VALUES ('a',\'b\',1)"                                                                        | "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    "/*dddbs='my-service',dde='Test'*/ INSERT INTO VALUE (col1,col2,col3) VALUES ('a',\'b\',1)"                                                                        | "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    "INSERT INTO VALUE (col1, col2, col3) VALUES ('a',\'b\',1)"                                                                      | "INSERT INTO VALUE (col1, col2, col3) VALUES (?,?,?)"
    "INSERT INTO VALUE ( col1, col2, col3 ) VALUES ('a',\'b\',1)"                                                                    | "INSERT INTO VALUE ( col1, col2, col3 ) VALUES (?,?,?)"
    "INSERT INTO VALUE (col1,col2,col3) VALUES ('a', \'b\' ,1)"                                                                      | "INSERT INTO VALUE (col1,col2,col3) VALUES (?, ? ,?)"
    "INSERT INTO VALUE (col1, col2, col3) VALUES ('a', \'b\', 1)"                                                                    | "INSERT INTO VALUE (col1, col2, col3) VALUES (?, ?, ?)"
    ...
    "/*dddbs='my-service',dde='Test'*/ INSERT INTO VALUE (col1,col2,col3) VALUES (X'ff',\'罿潯罿潯罿潯罿潯罿潯\',12983)"                                                         | "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    "/*dddbs='my-service',dde='Test'*/ INSERT INTO VALUE (col1,col2,col3) VALUES (X'ff',\'罿\',12983)"                                                                  | "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    "INSERT INTO VALUE (col1,col2,col3) VALUES (X'ff',\'罿\',12983)"                                                                  | "INSERT INTO VALUE (col1,col2,col3) VALUES (?,?,?)"
    "/*dddbs='my-service',dde='Test'*/ SELECT 3 AS NUCLEUS_TYPE,A0.ID,A0.\"NAME\" FROM \"VALUE\" A0"                                                                   | "SELECT ? AS NUCLEUS_TYPE,A0.ID,A0.\"NAME\" FROM \"VALUE\" A0"
    "SELECT 3 AS NUCLEUS_TYPE,A0.ID,A0.\"NAME\" FROM \"VALUE\" A0"                                                                   | "SELECT ? AS NUCLEUS_TYPE,A0.ID,A0.\"NAME\" FROM \"VALUE\" A0"
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > .9999"                                      | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > 0.9999"                                     | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > -1e6"                                       | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?"
    "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > +1e6"                                       | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?"
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > +1e6"                                       | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 > ?"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \'\'"                                      | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \'"                                     | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \'  \'"                                    | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \'  \'"                                    | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \\\' \'"                                | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \\\'Бегите, глупцы \'"                  | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' x\\\'ab x\'"                            | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    ...
    "/*dddbs='my-service',dde='Test'*/ SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> \' \\\' 0xf \'"                            | "SELECT COUNT(*) FROM TABLE_1 JOIN table_2 ON TABLE_1.foo = table_2.bar where col1 <> ?"
    ...
    """/*dddbs='my-service',dde='Test'*/ SELECT
