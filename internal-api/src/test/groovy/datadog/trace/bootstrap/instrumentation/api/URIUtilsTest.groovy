...
class URIUtilsTest extends DDSpecification {
  ...
  def "should decode URL-encoded ignoring + \"#encoded\" -> \"#expected\""() {
    ...
    "%"                                 | "�"                         // invalid % sequence with to few characters
    "%1"                                | "�"                         // invalid % sequence with to few characters
    ...
    "wh%"                               | "wh�"                       // invalid % sequence with to few characters
    "wh%1"                              | "wh�"                       // invalid % sequence with to few characters
